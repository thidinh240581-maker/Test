-- Gravity Hub — Final Clean / Logic-Preservation Pass
-- Built from the supplied GRAVITY-SKIDDED.lua.
-- Reference source: DIOLoader-3 (1).txt
-- UI library: librarydiofind(Copy).luau
--
-- This pass deliberately avoids speculative reconstruction. It preserves
-- statement order, callbacks, control flow, remote calls, and state slots.
...
Attack["Alive"] = function(L_10_arg0)
	local L_11_ = {}
	L_11_[2] = L_10_arg0
	if not L_11_[2] then
		return
...
Attack["DistH"] = function(L_18_arg0, L_19_arg1)
	local L_20_ = {}
...
Attack["Kill"] = function(L_21_arg0, L_22_arg1)
	local L_23_ = {}
...
Attack["Kill2"] = function(L_25_arg0, L_26_arg1)
	local L_27_ = {}
...
Attack["KillSea"] = function(L_29_arg0, L_30_arg1)
	local L_31_ = {}
...
Attack["Sword"] = function(L_33_arg0, L_34_arg1)
	local L_35_ = {}
...
Attack["Mas"] = function(L_36_arg0, L_37_arg1)
	local L_38_ = {}
...
Attack["Masgun"] = function(L_39_arg0, L_40_arg1)
	local L_41_ = {}
...
BringEnemy = function()
	...
	for L_46_forvar0, L_47_forvar1 in pairs(workspace["Enemies"]:GetChildren()) do
		...
		if (L_48_[3]["Position"] - L_45_[5]["Position"])["Magnitude"] <= L_45_[8] then
			...
			L_48_[3]["AssemblyLinearVelocity"] = Vector3["zero"]
			L_48_[3]["AssemblyAngularVelocity"] = Vector3["zero"]
...
vars[96] = getrawmetatable(game)
vars[123] = vars[96]["__namecall"]
setreadonly(vars[96], false)
vars[96]["__namecall"] = newcclosure(function(...)
	local L_61_ = {}
		...
		if tostring(L_61_[1][1]) == "RemoteEvent" then
			if tostring(L_61_[1][2]) ~= "true" and tostring(L_61_[1][2]) ~= "false" then
				if _G["FarmMastery_G"] and not SoulGuitar or _G["FarmMastery_Dev"] or _G["FarmBlazeEM"] or _G["Prehis_Skills"] or _G["SeaBeast1"] or _G["FishBoat"] or _G["PGB"] or _G["Leviathan1"] or _G["Complete_Trials"] or _G["AimMethod"] and ABmethod == "Aim Player" or _G["AimMethod"] and ABmethod == "Nearest Aim" then
					L_61_[1][2] = MousePos
					return vars[123](unpack(L_61_[1]))
				end
			end
		end
	end
...
LowCpu = function()
	...
	for L_74_forvar0, L_75_forvar1 in pairs(L_70_[6]:GetChildren()) do
		...
		if L_76_[1]:IsA("BlurEffect") or L_76_[1]:IsA("SunRaysEffect") or L_76_[1]:IsA("ColorCorrectionEffect") or L_76_[1]:IsA("BloomEffect") or L_76_[1]:IsA("DepthOfFieldEffect") then
...
CheckShark = function()
	for L_86_forvar0, L_87_forvar1 in pairs(workspace["Enemies"]:GetChildren()) do
		...
		if L_88_[3]["Name"] == "Shark" and Attack["Alive"](L_88_[3]) then
			return true
		end
	end
	return false
...
CheckTerrorShark = function()
	for L_89_forvar0, L_90_forvar1 in pairs(workspace["Enemies"]:GetChildren()) do
		...
		if L_91_[1]["Name"] == "Terrorshark" and Attack["Alive"](L_91_[1]) then
			return true
		end
	end
	return false
...
CheckPiranha = function()
	for L_92_forvar0, L_93_forvar1 in pairs(workspace["Enemies"]:GetChildren()) do
		...
		if L_94_[1]["Name"] == "Piranha" and Attack["Alive"](L_94_[1]) then
			return true
		end
	end
	return false
...
CheckFishCrew = function()
	for L_95_forvar0, L_96_forvar1 in pairs(workspace["Enemies"]:GetChildren()) do
		...
		if (L_97_[2]["Name"] == "Fish Crew Member" or L_97_[2]["Name"] == "Haunted Crew Member") and Attack["Alive"](L_97_[2]) then
			return true
		end
	end
	return false
...
CheckHauntedCrew = function()
	for L_98_forvar0, L_99_forvar1 in pairs(workspace["Enemies"]:GetChildren()) do
		...
		if L_100_[2]["Name"] == "Haunted Crew Member" and Attack["Alive"](L_100_[2]) then
			return true
		end
	end
	return false
...
vars[36] = Instance["new"]("Part", workspace)
vars[36]["Size"] = Vector3["new"](1, 1, 1)
vars[36]["Name"] = "Rip_Indra"
vars[36]["Anchored"] = true
vars[36]["CanCollide"] = false
vars[36]["CanTouch"] = false
vars[36]["Transparency"] = 1
vars[34] = workspace:FindFirstChild(vars[36]["Name"])
if vars[34] and vars[34] ~= vars[36] then
	vars[34]:Destroy()
end
task["spawn"](function()
	while task["wait"]() do
		if vars[36] and vars[36]["Parent"] == workspace then
			if shouldTween then
				(getgenv())["OnFarm"] = true
			else
...
task["spawn"](function()
	...
	vars[36]["CFrame"] = L_148_[1]["Character"]["PrimaryPart"]["CFrame"]
	while task["wait"]() do
		pcall(function()
			if (getgenv())["OnFarm"] then
				...
				if vars[36] and vars[36]["Parent"] == workspace then
					...
					if L_150_[2] and (L_150_[2]["Position"] - vars[36]["Position"])["Magnitude"] <= 200 then
						L_150_[2]["CFrame"] = vars[36]["CFrame"]
					else
						vars[36]["CFrame"] = L_150_[2]["CFrame"]
					end
				end
...
_tp = function(L_158_arg0)
	...
	L_159_[1] = (game:GetService("TweenService")):Create(vars[36], L_159_[7], {
		["CFrame"] = L_159_[4]
	})
	if plr["Character"]["Humanoid"]["Sit"] == true then
		vars[36]["CFrame"] = CFrame["new"](vars[36]["Position"]["X"], L_159_[4]["Y"], vars[36]["Position"]["Z"])
	end
	L_159_[1]:Play()
	task["spawn"](function()
...
vars[16] = loadstring(game:HttpGet("https://raw.githubusercontent.com/thidinh240581-maker/Test/refs/heads/main/librarydiofind(Copy).luau"))()
vars[38] = vars[16]:MakeWindow({
	["Title"] = "Gravity Hub";
	["SubTitle"] = "by realtboy",
	["SaveFolder"] = "redz library V5.json"
})
vars[87] = Instance["new"]("ScreenGui")
vars[87]["Name"] = "ControlGUI"
vars[87]["Parent"] = game["CoreGui"]
vars[41] = Instance["new"]("ImageButton")
vars[41]["Size"] = UDim2["new"](0, 50, 0, 50)
vars[41]["Position"] = UDim2["new"](.15, 0, .15, 0)
vars[41]["Image"] = "rbxassetid://73675787844710"
vars[41]["BackgroundTransparency"] = 1
vars[41]["Parent"] = vars[87]
vars[82] = Instance["new"]("UICorner")
vars[82]["CornerRadius"] = UDim["new"](.5, 0)
vars[82]["Parent"] = vars[41]
vars[25] = Instance["new"]("UIStroke", vars[41])
vars[25]["Thickness"] = 2
vars[25]["ApplyStrokeMode"] = Enum["ApplyStrokeMode"]["Border"]
vars[76] = {
...
task["spawn"](function()
	...
	L_181_[1] = 1
	while true do
		vars[25]["Color"] = vars[76][L_181_[1]]
		L_181_[1] = L_181_[1] % #vars[76] + 1
		task["wait"](.3)
	end
end)
vars[78] = false
vars[73] = function(L_182_arg0)
	local L_183_ = {}
	L_183_[3] = L_182_arg0
	L_183_[2] = L_183_[3]["Position"] - vars[33]
	vars[41]["Position"] = UDim2["new"](vars[92]["X"]["Scale"], vars[92]["X"]["Offset"] + L_183_[2]["X"], vars[92]["Y"]["Scale"], vars[92]["Y"]["Offset"] + L_183_[2]["Y"])
end
vars[41]["InputBegan"]:Connect(function(L_184_arg0)
	local L_185_ = {}
	L_185_[2] = L_184_arg0
	if L_185_[2]["UserInputType"] == Enum["UserInputType"]["MouseButton1"] or L_185_[2]["UserInputType"] == Enum["UserInputType"]["Touch"] then
		vars[78] = true
		vars[33] = L_185_[2]["Position"]
		vars[92] = vars[41]["Position"]
...
vars[41]["InputChanged"]:Connect(function(L_186_arg0)
	local L_187_ = {}
	L_187_[1] = L_186_arg0
...
(game:GetService("UserInputService"))["InputChanged"]:Connect(function(L_188_arg0)
	local L_189_ = {}
	L_189_[1] = L_188_arg0
	if vars[78] and L_189_[1] == vars[104] then
		vars[73](L_189_[1])
	end
end)
vars[108] = true
vars[41]["MouseButton1Click"]:Connect(function()
	vars[108] = not vars[108]
	vars[38]:Minimize(not vars[108])
end)
vars[93] = {
	["Info"] = vars[38]:MakeTab({
		["Title"] = "Tab Home";
		["Icon"] = "Info"
	});
	["Main"] = vars[38]:MakeTab({
		["Title"] = "Tab Farming";
		["Icon"] = "rbxassetid://7733960981"
	}),
	["Settings"] = vars[38]:MakeTab({
		["Title"] = "Tab Setting",
		["Icon"] = "rbxassetid://7734053495"
	});
	["Fish"] = vars[38]:MakeTab({
		["Title"] = "Tab Fishing";
		["Icon"] = "rbxassetid://127664059821666"
	}),
	["Quests"] = vars[38]:MakeTab({
		["Title"] = "Tab Quest And Item";
		["Icon"] = "rbxassetid://13075622619"
	}),
	["SeaEvent"] = vars[38]:MakeTab({
		["Title"] = "Tab Sea Event";
		["Icon"] = "waves"
	});
	["Race"] = vars[38]:MakeTab({
		["Title"] = "Tab Mirage And Race",
		["Icon"] = "rbxassetid://11162889532"
	}),
	["Prehistoric"] = vars[38]:MakeTab({
	...
	["Raids"] = vars[38]:MakeTab({
		["Title"] = "Tab Fruit And Raid";
		["Icon"] = "rbxassetid://11155986081"
	}),
	["Combat"] = vars[38]:MakeTab({
		["Title"] = "Tab Local Player",
		["Icon"] = "rbxassetid://13075651575"
	}),
	["Travel"] = vars[38]:MakeTab({
		["Title"] = "Tab Teleport";
		["Icon"] = "locate"
	});
	["Shop"] = vars[38]:MakeTab({
		["Title"] = "Tab Shopping";
		["Icon"] = "rbxassetid://6031265976"
	}),
	["Misc"] = vars[38]:MakeTab({
		["Title"] = "Tab Miscellaneous",
		["Icon"] = "rbxassetid://10709783577"
	})
}
vars[93]["Info"]:AddSection("Information")
vars[93]["Info"]:AddDiscordInvite({
	["Name"] = "Gravity Hub",
	["Description"] = "Release Date [12/10/2025]",
	["Logo"] = "rbxassetid://73675787844710",
	["Invite"] = "https://discord.gg/dvqDj9tum4"
})
vars[93]["Info"]:AddSection("Status Server")
Time = vars[93]["Info"]:AddParagraph({
	["Title"] = "Time Zone";
	["Content"] = ""
})
function UpdateOS()
...
Timmessss = vars[93]["Info"]:AddParagraph({
	["Title"] = "Time",
	["Content"] = ""
})
function UpdateTime()
...
Miragecheck = vars[93]["Info"]:AddParagraph({
	["Title"] = "Mirage Island";
	["Content"] = "Status: "
})
vars[77] = ""
...
Kitsunecheck = vars[93]["Info"]:AddParagraph({
...
CPrehistoriccheck = vars[93]["Info"]:AddParagraph({
...
FrozenIsland = vars[93]["Info"]:AddParagraph({
...
MobCakePrince = vars[93]["Info"]:AddParagraph({
...
CheckRip = vars[93]["Info"]:AddParagraph({
	["Title"] = "Rip_Indra";
	["Content"] = "Status: "
})
spawn(function()
...
CheckDoughKing = vars[93]["Info"]:AddParagraph({
	["Title"] = "Dough King";
	["Content"] = "Status: "
})
spawn(function()
...
EliteHunter = vars[93]["Info"]:AddParagraph({
	["Title"] = "Elite Hunter";
	["Content"] = "Status: "
})
spawn(function()
...
task["spawn"](function()
	while task["wait"](1) do
		...
		L_207_[3] = "Moon: 0/5"
		if L_207_[1] == "http://www.roblox.com/asset/?id=9709149431" then
			L_207_[3] = "Moon: 5/5"
		elseif L_207_[1] == "http://www.roblox.com/asset/?id=9709149052" then
			L_207_[3] = "Moon: 4/5"
		elseif L_207_[1] == "http://www.roblox.com/asset/?id=9709143733" then
			L_207_[3] = "Moon: 3/5"
		elseif L_207_[1] == "http://www.roblox.com/asset/?id=9709150401" then
			L_207_[3] = "Moon: 2/5"
		elseif L_207_[1] == "http://www.roblox.com/asset/?id=9709149680" then
			L_207_[3] = "Moon: 1/5"
		end
		FM:SetDesc(L_207_[3])
	end
end)
LegendarySword = vars[93]["Info"]:AddParagraph({
...
spawn(function()
	...
	while wait(1) do
		local L_209_ = {}
		L_209_[1] = "Not Found Legend Swords"
...
StatusBone = vars[93]["Info"]:AddParagraph({
	["Title"] = "Bone";
	["Content"] = ""
})
spawn(function()
...
WeaponDropdown = vars[93]["Main"]:AddDropdown({
	["Name"] = "Select Weapon",
	["Options"] = {
		"Melee";
		"Sword",
...
AttackDropdown = vars[93]["Main"]:AddDropdown({
	...
	["Callback"] = function(L_224_arg0)
		local L_225_ = {}
		L_225_[2] = L_224_arg0
		_G["FastAttackGravity_Mode"] = L_225_[2]
	end
})
vars[54] = {
	["Normal Attack"] = .25,
...
spawn(function()
	while task["wait"](.1) do
		pcall(function()
			if _G["FastAttackGravity_Mode"] and vars[54][_G["FastAttackGravity_Mode"]] then
				_G["Fast_Delay"] = vars[54][_G["FastAttackGravity_Mode"]]
			end
		end)
	end
end)
vars[93]["Main"]:AddSection({
	"Farming"
})
FarmLevel = vars[93]["Main"]:AddToggle({
	...
	while task["wait"](Sec) do
		if _G["Level"] then
			pcall(function()
				...
				if L_229_[7] >= 2600 and (not L_229_[2] and (not vars[133] and not vars[44])) then
					local L_230_ = {}
					vars[133] = true
				...
				elseif L_229_[2] or L_229_[7] < 2600 then
					...
					if not L_229_[1]["Visible"] then
						...
						for L_235_forvar0, L_236_forvar1 in pairs(workspace["Enemies"]:GetChildren()) do
							...
							if Attack["Alive"](L_237_[1]) and L_237_[1]["Name"] == L_234_[3] then
								L_234_[2] = true
								repeat
									task["wait"](Sec)
									_tp(L_237_[1]["HumanoidRootPart"]["CFrame"] * CFrame["new"](0, 10, 0))
									Attack["Kill"](L_237_[1], _G["Level"])
...
ClosetMons = vars[93]["Main"]:AddToggle({
				...
				for L_240_forvar0, L_241_forvar1 in pairs(workspace["Enemies"]:GetChildren()) do
					...
					if L_242_[1]:FindFirstChild("Humanoid") or L_242_[1]:FindFirstChild("HumanoidRootPart") then
						if L_242_[1]["Humanoid"]["Health"] > 0 then
							repeat
								wait()
								Attack["Kill"](L_242_[1], _G["AutoFarmNear"])
...
FactoryRaids = vars[93]["Main"]:AddToggle({
...
CastleRaids = vars[93]["Main"]:AddToggle({
						...
						if L_251_[2]:FindFirstChild("HumanoidRootPart") and (L_251_[2]:FindFirstChild("Humanoid") and L_251_[2]["Humanoid"]["Health"] > 0) then
							if L_251_[2]["Name"] then
								if (L_251_[2]["HumanoidRootPart"]["Position"] - Root["Position"])["Magnitude"] <= 2000 then
									repeat
										wait()
										Attack["Kill"](L_251_[2], _G["AutoRaidCastle"])
	...
	while wait(Sec) do
		pcall(function()
			if _G["AutoEctoplasm"] then
				...
				if Attack["Alive"](L_260_[2]) then
					repeat
						wait()
						Attack["Kill"](L_260_[2], _G["AutoEctoplasm"])
...
vars[93]["Main"]:AddDropdown({
	["Name"] = "Select Time Stop Farm (Minutes)";
	["Options"] = {
		"1",
		"2",
		"3",
...
vars[93]["Main"]:AddToggle({
	["Name"] = "Auto Farm Level + Collect Gift";
	["Description"] = "Select Time And Select Island Gift",
	["Default"] = false,
...
vars[93]["Main"]:AddToggle({
	["Name"] = "Auto Farm Candy + Collect Gift",
	["Description"] = "Select Time And Select Island Gift";
	["Description"] = "",
	["Default"] = false;
...
task["spawn"](function()
	while task["wait"](.1) do
		if _G["MasterAutoCandy"] and _G["AutoFarmCandy"] then
			pcall(function()
				local L_281_ = {}
				L_281_[3] = plr["Character"] or plr["CharacterAdded"]:Wait()
				L_281_[4] = L_281_[3]:WaitForChild("HumanoidRootPart")
				L_281_[1] = plr["Data"]["Level"]["Value"]
				L_281_[5] = vars[124]()
				if L_281_[1] >= 2600 and (not L_281_[5] and (not vars[40] and not vars[84])) then
					local L_282_ = {}
					vars[40] = true
					...
					if _G["AutoFarmCandy"] and _G["MasterAutoCandy"] then
						...
						pcall(function()
							...
							(replicated["Modules"]["Net"]:FindFirstChild("RF/SubmarineWorkerSpeak")):InvokeServer(unpack(L_283_[1]))
						end)
						task["wait"](2)
						vars[84] = true
					end
				...
				elseif L_281_[5] or L_281_[1] < 2600 then
					...
					if L_284_[3] then
						repeat
							...
							Attack["Kill"](L_284_[3], _G["AutoFarmCandy"])
...
Countdown = vars[93]["Main"]:AddParagraph({
...
vars[127] = function()
	local L_290_ = {}
	L_290_[1] = os["time"]()
	L_290_[3] = L_290_[1] % vars[79]
	return vars[79] - L_290_[3]
end
vars[135] = function()
	local L_291_ = {}
	L_291_[2] = vars[127]()
...
spawn(function()
	while wait(Sec) do
		if _G["AutoFarmCandy"] then
			pcall(function()
				local L_294_ = {}
				L_294_[1] = plr["Character"] or plr["CharacterAdded"]:Wait()
				L_294_[5] = L_294_[1]:WaitForChild("HumanoidRootPart")
				L_294_[2] = plr["Data"]["Level"]["Value"]
				L_294_[4] = vars[124]()
				if L_294_[2] >= 2600 and (not L_294_[4] and (not vars[107] and not vars[109])) then
					local L_295_ = {}
					vars[107] = true
					...
					pcall(function()
						...
						((game:GetService("ReplicatedStorage"))["Modules"]["Net"]:FindFirstChild("RF/SubmarineWorkerSpeak")):InvokeServer(unpack(L_296_[1]))
					end)
					L_295_[2] = tick()
					repeat
						local L_297_ = {}
				...
				elseif L_294_[4] or L_294_[2] < 2600 then
					...
					if L_298_[3] then
						repeat
							...
							Attack["Kill"](L_298_[3], _G["AutoFarmCandy"])
...
vars[58] = CFrame["new"](521.277832, 9.30464935, -3339.21753, .563576221, 0, .82606405, 0, 1, 0, -0.82606405, 0, .563576221)
vars[28] = CFrame["new"](-5405.59082, 8.06555939, 1451.85144, -0.987686276, 0, .156449571, 0, 1, 0, -0.156449571, 0, -0.987686276)
vars[94] = CFrame["new"](-1093.90479, 59.8575134, -14520.4658, -1, 0, 0, 0, 1, 0, 0, 0, -1)
vars[6] = {
	["GiftMap1"] = vars[58],
	["GiftMap2"] = vars[28],
	["GiftMap3"] = vars[94]
...
task["spawn"](function()
	while task["wait"](1) do
		if _G["AutoTP_Gift"] and _G["SelectedGiftMap"] then
			local L_308_ = {}
			L_308_[1] = vars[6][_G["SelectedGiftMap"]]
			if L_308_[1] then
				_tp(L_308_[1])
			end
		end
...
task["spawn"](function()
	...
	while task["wait"](.3) do
		...
		elseif not L_313_[2] and _G["SelectedGiftMap"] then
			local L_316_ = {}
			L_316_[1] = vars[6][_G["SelectedGiftMap"]]
			if L_316_[1] then
				_tp(L_316_[1])
				L_313_[2] = true
			end
...
AutoStoreGift = vars[93]["Main"]:AddToggle({
...
ChestTW = vars[93]["Main"]:AddToggle({
...
ChestBP = vars[93]["Main"]:AddToggle({
		...
		if _G["AutoBerryH"] then
			...
			if #L_384_[3] == 0 then
				...
				L_385_[5], L_385_[2] = pcall(function()
					L_385_[1] = (game:GetService("HttpService")):JSONDecode(game:HttpGet("https://games.roblox.com/v1/games/" .. (game["PlaceId"] .. "/servers/Public?sortOrder=Asc&limit=100")))
				end)
						...
						if L_409_[1]["Name"] == (getgenv())["SelectMob"] then
							if L_409_[1]:FindFirstChild("Humanoid") and (L_409_[1]:FindFirstChild("HumanoidRootPart") and L_409_[1]["Humanoid"]["Health"] > 0) then
								repeat
									...
									Attack["Kill"](L_409_[1], _G["AutoKillMob"])
...
task["spawn"](function()
	while task["wait"](.2) do
		...
		L_418_[1] = vars[60][_G["SelectIsland"]]
...
Process = vars[93]["Main"]:AddParagraph({
...
EliteHunter = vars[93]["Main"]:AddParagraph({
	["Title"] = "Elite Spawn";
	["Content"] = "Status: "
})
spawn(function()
	...
	while wait(1) do
		pcall(function()
			if _G["FarmEliteHunt"] then
				local L_429_ = {}
				L_429_[2] = plr["PlayerGui"]["Main"]["Quest"]
				L_429_[3] = L_429_[2]["Container"]["QuestTitle"]["Title"]["Text"]
				if not L_429_[2]["Visible"] then
					local L_430_ = {}
					L_430_[2] = replicated["Remotes"]["CommF_"]:InvokeServer("EliteHunter")
					...
					if L_431_[2] then
						local L_435_ = {}
						L_435_[2] = nil
						for L_436_forvar0, L_437_forvar1 in pairs(replicated:GetChildren()) do
							local L_438_ = {}
						...
						for L_439_forvar0, L_440_forvar1 in pairs(Enemies:GetChildren()) do
							...
							if L_441_[3]["Name"] == L_431_[2] and Attack["Alive"](L_441_[3]) then
								L_435_[2] = L_441_[3]
								break
							end
						end
						if L_435_[2] and L_435_[2]:FindFirstChild("HumanoidRootPart") then
							...
							repeat
								wait()
								Attack["Kill"](L_435_[2], _G["FarmEliteHunt"])
	...
	while task["wait"](1) do
		pcall(function()
			if _G["FarmEliteH"] then
				local L_450_ = {}
				L_450_[2] = plr["PlayerGui"]["Main"]["Quest"]
				L_450_[1] = L_450_[2]["Container"]["QuestTitle"]["Title"]["Text"]
				if not L_450_[2]["Visible"] then
					local L_451_ = {}
					L_451_[1] = replicated["Remotes"]["CommF_"]:InvokeServer("EliteHunter")
					...
					if L_452_[1] then
						local L_456_ = {}
						L_456_[1] = nil
						for L_457_forvar0, L_458_forvar1 in pairs(replicated:GetChildren()) do
							local L_459_ = {}
						...
						for L_460_forvar0, L_461_forvar1 in pairs(workspace["Enemies"]:GetChildren()) do
							...
							if L_462_[1]["Name"] == L_452_[1] and Attack["Alive"](L_462_[1]) then
								L_456_[1] = L_462_[1]
								break
							end
						end
						if L_456_[1] and L_456_[1]:FindFirstChild("HumanoidRootPart") then
							...
							repeat
								wait()
								Attack["Kill"](L_456_[1], _G["FarmEliteH"])
		...
		pcall(function()
			if _G["AutoRipIngay"] then
				...
				if not GetWP("Dark Dagger") or not GetIn("Valkyrie") and L_465_[2] then
					repeat
						wait()
						Attack["Kill"](L_465_[2], _G["AutoRipIngay"])
...
AuraSkin = function(L_468_arg0)
	...
	(((replicated:WaitForChild("Modules")):WaitForChild("Net")):WaitForChild("RF/FruitCustomizerRF")):InvokeServer(unpack(L_469_[1]))
end
...
MobKilled = vars[93]["Main"]:AddParagraph({
	["Title"] = "Cake Princes :";
	["Content"] = ""
})
spawn(function()
	while wait(.2) do
		pcall(function()
			local L_479_ = {}
			L_479_[1] = string["match"](replicated["Remotes"]["CommF_"]:InvokeServer("CakePrinceSpawner"), "%d+")
			if L_479_[1] then
			...
			pcall(function()
				...
				if L_482_[7] and (L_482_[7]["Other"]["Transparency"] == 0 or L_482_[5]:FindFirstChild("Cake Prince")) then
					...
					if L_484_[1] then
						repeat
							task["wait"]()
							Attack["Kill2"](L_484_[1], _G["Auto_Cake_Prince"])
					...
					if L_485_[2] then
						repeat
							task["wait"]()
							Attack["Kill"](L_485_[2], _G["Auto_Cake_Prince"])
			...
			pcall(function()
				...
				elseif workspace["Map"]["CakeLoaf"]:FindFirstChild("RedDoor") then
					if GetBP("Red Key") then
						...
						until not(getgenv())["AutoDoughKing"] or (plr["Character"]["HumanoidRootPart"]["CFrame"] - CFrame["new"](-2681.97998, 64.3921585, -12853.7363, .149007782, -1.87902192e-08, .98883605, 3.60619588e-08, 1, 1.35681812e-08, -0.98883605, 3.36376011e-08, .149007782))["Magnitude"] <= 5
						EquipWeapon("Red Key")
					end
				elseif GetConnectionEnemies("Dough King") then
					...
					if L_493_[1] then
						repeat
							task["wait"]()
							Attack["Kill"](L_493_[1], _G["AutoDoughKing"])
				...
				if GetM("Conjured Cocoa") <= 10 then
					...
					if L_494_[2] then
						repeat
							task["wait"]()
							Attack["Kill"](L_494_[2], _G["AutoDoughKing"])
		...
		if _G["AutoAttackDoughKing"] then
			pcall(function()
				...
				if L_497_[1] then
					repeat
						task["wait"]()
						Attack["Kill"](L_497_[1], _G["AutoAttackDoughKing"])
...
vars[116] = function()
	pcall(function()
		...
		L_500_[1] = {}
		L_500_[2] = game:HttpGet("https://games.roblox.com/v1/games/" .. (game["PlaceId"] .. "/servers/Public?sortOrder=Asc&limit=100"))
		...
		if _G["AutoHop_Dough"] then
			pcall(function()
				...
				if L_504_[2] then
					repeat
						task["wait"]()
						Attack["Kill"](L_504_[2], _G["AutoHop_Dough"])
			...
			pcall(function()
				...
				elseif GetConnectionEnemies("Dough King") then
					...
					if L_508_[2] then
						repeat
							wait()
							Attack["Kill"](L_508_[2], _G["Doughv2"])
				...
				if GetM("Conjured Cocoa") <= 10 then
					...
					if L_509_[3] then
						repeat
							wait()
							Attack["Kill"](L_509_[3], _G["Doughv2"])
...
CheckingBone = vars[93]["Main"]:AddParagraph({
	["Title"] = " Bones :",
	["Content"] = ""
})
spawn(function()
		...
		if _G["AutoHytHallow"] then
			pcall(function()
				...
				if L_521_[2] then
					repeat
						task["wait"]()
						Attack["Kill"](L_521_[2], _G["AutoHytHallow"])
...
RanBone = vars[93]["Main"]:AddToggle({
...
spawn(function()
	while wait(Sec) do
		if _G["TryLucky"] then
			...
			if plr["Character"]["HumanoidRootPart"]["CFrame"] ~= L_526_[1] then
				_tp(CFrame["new"](-8761.3154296875, 164.85829162598, 6161.1567382813))
			elseif plr["Character"]["HumanoidRootPart"]["CFrame"] == L_526_[1] then
				replicated["Remotes"]["CommF_"]:InvokeServer("gravestoneEvent", 1)
			end
		end
	end
end)
Pray = vars[93]["Main"]:AddToggle({
...
spawn(function()
	while wait(Sec) do
		if _G["Praying"] then
			...
			if plr["Character"]["HumanoidRootPart"]["CFrame"] ~= L_529_[2] then
				_tp(CFrame["new"](-8761.3154296875, 164.85829162598, 6161.1567382813))
			elseif plr["Character"]["HumanoidRootPart"]["CFrame"] == L_529_[2] then
...
TyrantStatus = vars[93]["Main"]:AddParagraph({
	["Title"] = "Boss Spawn",
	["Content"] = ""
})
spawn(function()
...
EyeStatus = vars[93]["Main"]:AddParagraph({
...
FarmTyrant = vars[93]["Main"]:AddToggle({
	["Name"] = "Auto Farm Boss";
	["Description"] = "",
	["Default"] = false,
	...
	while wait(Sec) do
		if _G["FarmTyrant"] then
			pcall(function()
				...
				L_538_[3] = plr["Character"]:FindFirstChild("HumanoidRootPart")
				...
				if (L_538_[3]["Position"] - L_538_[1])["Magnitude"] > 5 then
					...
					repeat
						wait()
					until not _G["FarmTyrant"] or plr["Character"] and (plr["Character"]:FindFirstChild("HumanoidRootPart") and (plr["Character"]["HumanoidRootPart"]["Position"] - L_538_[1])["Magnitude"] <= 5)
				end
				...
				if L_538_[4] and (L_538_[4]:FindFirstChild("Humanoid") and L_538_[4]["Humanoid"]["Health"] > 0) then
					repeat
						...
						if Attack and Attack["Kill"] then
							Attack["Kill"](L_538_[4], _G["FarmTyrant"])
						end
						wait()
					...
					for L_542_forvar0, L_543_forvar1 in pairs(workspace["Enemies"]:GetChildren()) do
						...
						if L_544_[3] and (L_544_[3]["Name"] == L_541_[2] and (L_544_[3]:FindFirstChild("HumanoidRootPart") and (L_544_[3]:FindFirstChild("Humanoid") and L_544_[3]["Humanoid"]["Health"] > 0))) then
							if (L_538_[3]["Position"] - L_544_[3]["HumanoidRootPart"]["Position"])["Magnitude"] > 5000 then
								...
								repeat
									wait()
									L_538_[3] = plr["Character"] and plr["Character"]:FindFirstChild("HumanoidRootPart")
							...
							repeat
								...
								if Attack and Attack["Kill"] then
									Attack["Kill"](L_544_[3], _G["FarmTyrant"])
								end
								wait()
...
FarmPhaBinh = vars[93]["Main"]:AddToggle({
...
vars[3] = function(L_550_arg0)
	local L_551_ = {}
	L_551_[4] = L_550_arg0
	L_551_[2] = plr["Character"]
	L_551_[3] = plr["Backpack"]
	...
	while wait(Sec) do
		if _G["FarmPhaBinh"] then
			pcall(function()
				...
				for L_558_forvar0, L_559_forvar1 in ipairs(vars[101]) do
					local L_560_ = {}
					...
					while tick() - L_560_[2] < 12 and (not L_560_[1] and _G["FarmPhaBinh"]) do
						local L_561_ = {}
						L_561_[2] = plr["Character"] and plr["Character"]:FindFirstChild("HumanoidRootPart")
	...
	L_566_[1] = function(L_567_arg0, L_568_arg1)
		...
		if L_569_[3]:FindFirstChild("Humanoid") and (L_569_[3]:FindFirstChild("HumanoidRootPart") and L_569_[3]["Humanoid"]["Health"] > 0) then
			if L_569_[3]["Name"] == L_569_[1] then
				repeat
					wait()
					Attack["Kill"](L_569_[3], (getgenv())["AutoMaterial"])
...
BossDropdown = vars[93]["Main"]:AddDropdown({
	["Name"] = "Select Boss";
	["Description"] = "";
	["Options"] = BossList,
	["Default"] = false;
...
FarmBoss = vars[93]["Main"]:AddToggle({
	["Name"] = "Auto Farm Boss";
	["Description"] = "";
	["Default"] = false,
			...
			while wait(Sec) do
				if _G["FarmBoss"] then
					pcall(function()
						...
						L_586_[2] = plr["PlayerGui"]["Main"]["Quest"]["Container"]["QuestTitle"]["Title"]["Text"]
						if _G["AcceptQuestBoss"] and L_586_[1] then
							...
							elseif plr["PlayerGui"]["Main"]["Quest"]["Visible"] == true then
								if workspace["Enemies"]:FindFirstChild((QuestBeta())[1]) then
									for L_587_forvar0, L_588_forvar1 in pairs(workspace["Enemies"]:GetChildren()) do
										...
										if Attack["Alive"](L_589_[1]) and L_589_[1]["Name"] == (QuestBeta())[1] then
											if string["find"](L_586_[2], (QuestBeta())[0]) then
												repeat
													wait()
													Attack["Kill"](L_589_[1], _G["FarmBoss"])
												until not _G["FarmBoss"] or L_589_[1]["Humanoid"]["Health"] <= 0 or not L_589_[1]["Parent"] or plr["PlayerGui"]["Main"]["Quest"]["Visible"] == false
											else
												replicated["Remotes"]["CommF_"]:InvokeServer("AbandonQuest")
											end
										end
							...
							if workspace["Enemies"]:FindFirstChild((QuestBeta())[1]) then
								for L_590_forvar0, L_591_forvar1 in pairs(workspace["Enemies"]:GetChildren()) do
									...
									if Attack["Alive"](L_592_[1]) and L_592_[1]["Name"] == (QuestBeta())[1] then
										repeat
											wait()
											Attack["Kill"](L_592_[1], _G["FarmBoss"])
...
FarmAllBoss = vars[93]["Main"]:AddToggle({
...
vars[74] = vars[93]["Main"]:AddDropdown({
	["Name"] = "Choose Island";
	["Description"] = "",
	["Options"] = vars[17],
	["Default"] = false;
...
vars[137] = vars[93]["Main"]:AddToggle({
	...
	RunSer["RenderStepped"]:Connect(function()
		pcall(function()
			if _G["FarmMastery_Dev"] or _G["FarmMastery_G"] or _G["FarmMastery_S"] then
				for L_608_forvar0, L_609_forvar1 in pairs(plr["PlayerGui"]["Notifications"]:GetChildren()) do
					local L_610_ = {}
...
vars[46] = vars[93]["Main"]:AddToggle({
	...
	while wait(Sec) do
		if _G["FarmMastery_G"] then
			pcall(function()
				if SelectIsland == "Cake" then
					local L_615_ = {}
					L_615_[2] = GetConnectionEnemies(vars[122])
					if L_615_[2] then
						...
						repeat
							...
							Attack["Masgun"](L_615_[2], _G["FarmMastery_G"])
							L_616_[2] = replicated:FindFirstChild("Modules")
				...
				elseif SelectIsland == "Bone" then
					local L_617_ = {}
					L_617_[2] = GetConnectionEnemies(vars[95])
					if L_617_[2] then
						...
						repeat
							...
							Attack["Masgun"](L_617_[2], _G["FarmMastery_G"])
							L_618_[2] = replicated:FindFirstChild("Modules")
...
vars[29] = vars[93]["Main"]:AddToggle({
	...
	while wait(Sec) do
		pcall(function()
			if _G["FarmMastery_S"] then
				if SelectIsland == "Cake" then
					for L_621_forvar0, L_622_forvar1 in next, replicated["Remotes"]["CommF_"]:InvokeServer("getInventory") do
						local L_623_ = {}
						...
						if type(L_623_[2]) == "table" then
							if L_623_[2]["Type"] == "Sword" then
								...
								if tonumber(L_623_[2]["Mastery"]) >= 1 or tonumber(L_623_[2]["Mastery"]) <= 599 then
									local L_624_ = {}
									L_624_[2] = GetConnectionEnemies(vars[122])
									if GetBP(SwordName) then
										if L_624_[2] then
											repeat
												wait()
												Attack["Sword"](L_624_[2], _G["FarmMastery_S"])
				...
				elseif SelectIsland == "Bone" then
					for L_625_forvar0, L_626_forvar1 in next, replicated["Remotes"]["CommF_"]:InvokeServer("getInventory") do
						local L_627_ = {}
						...
						if type(L_627_[1]) == "table" then
							if L_627_[1]["Type"] == "Sword" then
								...
								if tonumber(L_627_[1]["Mastery"]) >= 1 or tonumber(L_627_[1]["Mastery"]) <= 599 then
									local L_628_ = {}
									L_628_[2] = GetConnectionEnemies(vars[95])
									if GetBP(SwordName) then
										if L_628_[2] then
											repeat
												wait()
												Attack["Sword"](L_628_[2], _G["FarmMastery_S"])
...
vars[93]["Settings"]:AddSection({
	"Settings / Configure"
})
Initialize = vars[93]["Settings"]:AddToggle({
	["Name"] = "Fast Attack",
	["Description"] = "",
	["Default"] = true,
...
Bringmob = vars[93]["Settings"]:AddToggle({
	["Name"] = "Bring Mobs";
	["Description"] = "",
	["Default"] = true,
...
BusuAura = vars[93]["Settings"]:AddToggle({
	...
	while wait(Sec) do
		pcall(function()
			if Boud then
				...
				if not plr["Character"]:FindFirstChild(L_647_[2][1]) then
					replicated["Remotes"]["CommF_"]:InvokeServer(L_647_[2][2])
				end
			end
		end)
	end
...
RaceV3Aura = vars[93]["Settings"]:AddToggle({
...
RaceV4Aura = vars[93]["Settings"]:AddToggle({
...
vars[93]["Settings"]:AddToggle({
	...
	["Callback"] = function(L_656_arg0)
		...
		L_657_[1] = plr["Character"] and plr["Character"]:FindFirstChild("Humanoid")
...
vars[93]["Settings"]:AddSlider({
	...
	["Callback"] = function(L_658_arg0)
		...
		L_659_[1] = plr["Character"] and plr["Character"]:FindFirstChild("Humanoid")
		if _G["WalkSpeedEnabled"] and L_659_[1] then
			L_659_[1]["WalkSpeed"] = L_659_[3]
		end
	end
})
plr["CharacterAdded"]:Connect(function(L_660_arg0)
	local L_661_ = {}
	L_661_[2] = L_660_arg0
...
if plr["Character"] then
	local L_662_ = {}
	L_662_[2] = plr["Character"]:FindFirstChild("Humanoid")
	if _G["WalkSpeedEnabled"] then
		vars[19](L_662_[2])
	end
end
vars[93]["Settings"]:AddToggle({
	...
	["Callback"] = function(L_663_arg0)
		...
		if L_664_[2] and plr["Character"] then
			local L_665_ = {}
			L_665_[1] = plr["Character"]:FindFirstChild("Humanoid")
			if L_665_[1] then
...
vars[93]["Settings"]:AddSlider({
	...
	["Callback"] = function(L_666_arg0)
		...
		if _G["JumpEnabled"] and plr["Character"] then
			local L_668_ = {}
			L_668_[2] = plr["Character"]:FindFirstChild("Humanoid")
			if L_668_[2] then
...
RandomAround = vars[93]["Settings"]:AddToggle({
...
Byp = vars[93]["Settings"]:AddToggle({
...
SafeModes = vars[93]["Settings"]:AddToggle({
	["Name"] = "Panic Mode";
	["Description"] = "",
	["Default"] = false,
...
spawn(function()
	while task["wait"](Sec) do
		pcall(function()
			if _G["Safemode"] then
				local L_675_ = {}
				L_675_[1] = (plr["Character"]["Humanoid"]["Health"] / plr["Character"]["Humanoid"]["MaxHealth"]) * 100
...
DisableHitVFX = vars[93]["Settings"]:AddToggle({
	["Name"] = "Remove Hit VFX";
		...
		if _G["DestroyHit"] then
			pcall(function()
				for L_678_forvar0, L_679_forvar1 in pairs(workspace["_WorldOrigin"]:GetChildren()) do
					...
					if table["find"](vars[1], L_680_[2]["Name"]) then
						L_680_[2]:Destroy()
					end
				end
			end)
...
RmvVFX = vars[93]["Settings"]:AddToggle({
...
DisblesNotify = vars[93]["Settings"]:AddToggle({
	["Name"] = "Disable Notify";
	["Description"] = "",
	["Default"] = false,
...
vars[93]["Esp"]:AddSection({
	"Stats Upgrade"
})
StatusSelect = vars[93]["Esp"]:AddSlider({
	["Name"] = "Stats Value",
	["Description"] = "",
	["Default"] = 10,
	["Min"] = 0,
...
StatsUpg = vars[93]["Esp"]:AddToggle({
	["Name"] = "Auto Melee",
	["Description"] = "";
	["Default"] = false;
...
vars[93]["Fish"]:AddSection({
	"Fishing"
})
vars[93]["Fish"]:AddDropdown({
...
BaitDropdown = vars[93]["Fish"]:AddDropdown({
	["Name"] = "Select Bait",
	["Description"] = "";
	["Options"] = {
		"Basic Bait";
	...
	["Callback"] = function(L_712_arg0)
		...
		if _G["AutoBuyBait"] then
			pcall(function()
				vars[64]["RFCraft"]:InvokeServer("Craft", _G["SelectedBait"], {})
			end)
		end
	end
})
BuyBaitToggle = vars[93]["Fish"]:AddToggle({
	["Name"] = "Auto Buy Bait",
	["Description"] = "";
	["Default"] = false;
...
FishingToggle = vars[93]["Fish"]:AddToggle({
	["Name"] = "Auto Fishing",
	["Description"] = "",
	["Default"] = false,
...
MaxLaunchDistance = FishingConfig["Rod"]["MaxLaunchDistance"]
task["spawn"](function()
	while task["wait"](.5) do
		if _G["AutoFishing"] then
			pcall(function()
				local L_718_ = {}
				L_718_[3] = plr["Character"] or plr["CharacterAdded"]:Wait()
				...
				if _G["SelectedRod"] and (not L_718_[1] or L_718_[1]["Name"] ~= _G["SelectedRod"]) then
					local L_719_ = {}
					L_719_[2] = plr["Backpack"]:FindFirstChild(_G["SelectedRod"])
					if L_719_[2] then
				...
				if L_718_[1] then
					local L_720_ = {}
					L_720_[3] = GetWaterHeightAtLocation(L_718_[2]["Position"])
					L_720_[5], L_720_[6] = Workspace:FindPartOnRayWithIgnoreList(Ray["new"](L_718_[3]["Head"]["Position"], L_718_[2]["CFrame"]["LookVector"] * MaxLaunchDistance), {
						L_718_[3];
					...
					if L_720_[7] and (L_720_[4] == "ReeledIn" or L_720_[1] == "ReeledIn") then
						...
						task["wait"]()
						FishingRequest:InvokeServer("CastLineAtLocation", L_720_[7], 100, true)
...
FishingQ = vars[93]["Fish"]:AddToggle({
...
plr = Players["LocalPlayer"]
ReplicatedStorage = game:GetService("ReplicatedStorage")
RFJobsRemoteFunction = ReplicatedStorage["Modules"]["Net"]:WaitForChild("RF/JobsRemoteFunction")
HasFishingQuest = function()
	local L_723_ = {}
	L_723_[2] = plr["PlayerGui"]:FindFirstChild("Quest") or plr["PlayerGui"]:FindFirstChild("QuestGui")
...
QuestToggle = vars[93]["Fish"]:AddToggle({
	...
	["Callback"] = function(L_724_arg0)
		...
		if L_725_[2] then
			pcall(function()
				vars[64]["RFJobsRemoteFunction"]:InvokeServer("FishingNPC", "FinishQuest")
			end)
		end
	end
})
...
SellFishToggle = vars[93]["Fish"]:AddToggle({
	["Name"] = "Auto Sell Fish";
	["Description"] = "",
	["Default"] = false;
	["Callback"] = function(L_726_arg0)
		...
		if L_727_[2] then
			pcall(function()
				vars[64]["RFJobsRemoteFunction"]:InvokeServer("FishingNPC", "SellFish")
			end)
		end
	end
})
...
SpamSkillZ = vars[93]["Fish"]:AddToggle({
...
vars[132] = game:GetService("ReplicatedStorage")
vars[97] = vars[132]["Modules"]["Net"]:WaitForChild("RF/JobToolAbilities")
task["spawn"](function()
	while task["wait"](.5) do
		if _G["AutoSkillZ"] then
			pcall(function()
				vars[97]:InvokeServer("Z", true)
			end)
		end
	end
end)
TravelDress = vars[93]["Quests"]:AddToggle({
					...
					elseif workspace["Map"]["Ice"]["Door"]["CanCollide"] == false and workspace["Map"]["Ice"]["Door"]["Transparency"] == 1 then
						if Enemies:FindFirstChild("Ice Admiral") then
							for L_732_forvar0, L_733_forvar1 in pairs(Enemies:GetChildren()) do
								...
								if L_734_[2]["Name"] == "Ice Admiral" and Attack["Alive"](L_734_[2]) then
									repeat
										task["wait"]()
										Attack["Kill"](L_734_[2], _G["TravelDres"])
					...
					if replicated["Remotes"]["CommF_"]:InvokeServer("BartiloQuestProgress", "Bartilo") == 3 then
						if (replicated["Remotes"]["CommF_"]:InvokeServer("GetUnlockables"))["FlamingoAccess"] ~= nil then
							...
							if replicated["Remotes"]["CommF_"]:InvokeServer("ZQuestProgress", "Check") == 0 then
								...
								if L_737_[2] then
									repeat
										wait()
										Attack["Kill"](L_737_[2], _G["AutoZou"])
							...
							elseif replicated["Remotes"]["CommF_"]:InvokeServer("ZQuestProgress", "Check") == 1 then
								...
								if L_738_[1] then
									repeat
										wait()
										Attack["Kill"](L_738_[1], _G["AutoZou"])
							...
							if (replicated["Remotes"]["CommF_"]:InvokeServer("GetUnlockables"))["FlamingoAccess"] == nil then
								...
								TabelDevilFruitOpen = {}
								for L_739_forvar0, L_740_forvar1 in pairs(replicated["Remotes"]["CommF_"]:InvokeServer("getInventoryFruits")) do
									local L_741_ = {}
								...
								for L_748_forvar0, L_749_forvar1 in pairs(TabelDevilFruitOpen) do
									...
									for L_751_forvar0, L_752_forvar1 in pairs(TabelDevilFruitStore) do
										...
										if L_750_[1] == L_753_[3] and (replicated["Remotes"]["CommF_"]:InvokeServer("GetUnlockables"))["FlamingoAccess"] == nil then
											if not plr["Backpack"]:FindFirstChild(L_753_[3]) then
												replicated["Remotes"]["CommF_"]:InvokeServer("F_", "LoadFruit", L_753_[3])
											else
							...
							if string["find"](plr["PlayerGui"]["Main"]["Quest"]["Container"]["QuestTitle"]["Title"]["Text"], "Swan Pirates") and (string["find"](plr["PlayerGui"]["Main"]["Quest"]["Container"]["QuestTitle"]["Title"]["Text"], "50") and plr["PlayerGui"]["Main"]["Quest"]["Visible"] == true) then
								...
								if L_754_[1] then
									pcall(function()
										repeat
											wait()
											Attack["Kill"](L_754_[1], _G["AutoZou"])
										until not L_754_[1]["Parent"] or L_754_[1]["Humanoid"]["Health"] <= 0 or _G["AutoZou"] == false or plr["PlayerGui"]["Main"]["Quest"]["Visible"] == false
									end)
								else
						...
						elseif replicated["Remotes"]["CommF_"]:InvokeServer("BartiloQuestProgress", "Bartilo") == 1 then
							...
							if L_755_[2] then
								repeat
									wait()
									Attack["Kill"](L_755_[2], _G["AutoZou"])
...
vars[93]["Quests"]:AddSection({
	"Tushita + Yama"
})
Q = vars[93]["Quests"]:AddToggle({
			...
			if _G["Auto_Tushita"] then
				if workspace["Map"]["Turtle"]:FindFirstChild("TushitaGate") then
					...
					if L_758_[1] then
						repeat
							task["wait"]()
							Attack["Kill"](L_758_[1], _G["Auto_Tushita"])
				...
				elseif replicated["Remotes"]["CommF_"]:InvokeServer("EliteHunter", "Progress") > 30 then
					...
					if (workspace["Map"]["Waterfall"]["SealedKatana"]["Handle"]["Position"] - plr["Character"]["HumanoidRootPart"]["Position"])["Magnitude"] >= 20 then
						...
						if L_761_[1] then
							repeat
								wait()
								Attack["Kill"](L_761_[1], _G["Auto_Yama"])
...
CheckSoul = vars[93]["Quests"]:AddParagraph({
				...
				if World3 then
					...
					elseif (replicated["Remotes"]["CommF_"]:InvokeServer("GuitarPuzzleProgress", "Check"))["Swamp"] == false then
						...
						if L_775_[1] then
							repeat
								task["wait"]()
								Attack["Kill"](L_775_[1], _G["Auto_Soul_Guitar"])
					...
					if GetM("Ectoplasm") <= 250 then
						if _G["AutoMatSoul"] and World2 then
							...
							if L_783_[3] then
								repeat
									task["wait"]()
									Attack["Kill"](L_783_[3], _G["AutoMatSoul"])
					...
					elseif GetM("Dark Fragment") < 1 then
						if _G["AutoMatSoul"] and World2 then
							...
							if L_784_[1] then
								repeat
									task["wait"]()
									Attack["Kill"](L_784_[1], _G["AutoMatSoul"])
					...
					elseif GetM("Bones") <= 500 then
						if _G["AutoMatSoul"] and World3 then
							...
							if L_785_[3] then
								repeat
									task["wait"]()
									Attack["Kill"](L_785_[3], _G["AutoMatSoul"])
...
CheckCDK = vars[93]["Quests"]:AddParagraph({
					...
					elseif (replicated["Remotes"]["CommF_"]:InvokeServer("CDKQuest", "Progress"))["Finished"] == false then
						...
						elseif tonumber((replicated["Remotes"]["CommF_"]:InvokeServer("CDKQuest", "Progress"))["Evil"]) == -4 then
							...
							for L_792_forvar0, L_793_forvar1 in pairs((game:GetService("Players"))["LocalPlayer"]["QuestHaze"]:GetChildren()) do
								...
								for L_795_forvar0, L_796_forvar1 in pairs(vars[22]) do
									local L_797_ = {}
										...
										if (L_797_[2]["Position"] - Root["Position"])["Magnitude"] <= 1000 and workspace["Enemies"]:FindFirstChild(L_797_[1]) then
											for L_798_forvar0, L_799_forvar1 in pairs(workspace["Enemies"]:GetChildren()) do
												...
												if L_800_[2]:FindFirstChild("HumanoidRootPart") and (L_800_[2]:FindFirstChild("Humanoid") and ((L_800_[2]:FindFirstChild("Humanoid"))["Health"] > 0 and L_800_[2]:FindFirstChild("HazeESP"))) then
													repeat
														wait()
														Attack["Kill"](L_800_[2], _G["CDK_YM"])
													until not _G["CDK_YM"] or tonumber((replicated["Remotes"]["CommF_"]:InvokeServer("CDKQuest", "Progress"))["Evil"]) == 2 or not L_800_[2]:FindFirstChild("HazeESP") or L_800_[2]["Humanoid"]["Health"] <= 0
												end
											end
										else
											_tp(L_797_[2])
									...
									for L_813_forvar0, L_814_forvar1 in pairs(workspace["Enemies"]:GetChildren()) do
										...
										if ((L_815_[3]:FindFirstChild("HumanoidRootPart"))["Position"] - workspace["Map"]["HellDimension"]["Spawn"]["Position"])["Magnitude"] <= 300 then
											if L_815_[3]:FindFirstChild("HumanoidRootPart") and (L_815_[3]:FindFirstChild("Humanoid") and (L_815_[3]:FindFirstChild("Humanoid"))["Health"] > 0) then
												repeat
													task["wait"]()
													Attack["Kill"](L_815_[3], _G["CDK_YM"])
												until not _G["CDK_YM"] or L_815_[3]["Humanoid"]["Health"] <= 0 or not L_815_[3]["Parent"] or tonumber((replicated["Remotes"]["CommF_"]:InvokeServer("CDKQuest", "Progress"))["Evil"]) == 3
											end
										end
									end
								end
				...
				if tonumber((replicated["Remotes"]["CommF_"]:InvokeServer("CDKQuest", "Progress"))["Evil"]) == -5 then
					if not workspace["Map"]:FindFirstChild("HellDimension") or (Root["Position"] - workspace["Map"]["HellDimension"]["Spawn"]["Position"])["Magnitude"] > 1000 then
						...
						if L_816_[2] then
							...
							until L_816_[2]["Humanoid"]["Health"] <= 0 or not _G["CDK_YM"] or not L_816_[2]["Parent"] or tonumber((replicated["Remotes"]["CommF_"]:InvokeServer("CDKQuest", "Progress"))["Evil"]) == 3 or workspace["Map"]:FindFirstChild("HellDimension") and (Root["Position"] - workspace["Map"]["HellDimension"]["Spawn"]["Position"])["Magnitude"] <= 1000
									...
									for L_817_forvar0, L_818_forvar1 in pairs(workspace["Enemies"]:GetChildren()) do
										...
										if L_819_[1]["Name"] == "Reborn Skeleton" or L_819_[1]["Name"] == "Living Zombie" or L_819_[1]["Name"] == "Demonic Soul" or L_819_[1]["Name"] == "Posessed Mummy" then
											if L_819_[1]:FindFirstChild("HumanoidRootPart") and (L_819_[1]:FindFirstChild("Humanoid") and (L_819_[1]:FindFirstChild("Humanoid"))["Health"] > 0) then
												repeat
													task["wait"]()
													Attack["Kill"](L_819_[1], _G["CDK_YM"])
								...
								for L_822_forvar0, L_823_forvar1 in pairs(workspace["Enemies"]:GetChildren()) do
									...
									if L_824_[3]["Name"] == "Cake Queen" then
										if L_824_[3]:FindFirstChild("Humanoid") and (L_824_[3]:FindFirstChild("HumanoidRootPart") and L_824_[3]["Humanoid"]["Health"] > 0) then
											repeat
												wait()
												Attack["Kill"](L_824_[3], _G["CDK_TS"])
											until not _G["CDK_TS"] or not L_824_[3]["Parent"] or L_824_[3]["Humanoid"]["Health"] <= 0 or tonumber((replicated["Remotes"]["CommF_"]:InvokeServer("CDKQuest", "Progress"))["Good"]) == 3
										end
									end
								end
									...
									for L_837_forvar0, L_838_forvar1 in pairs(workspace["Enemies"]:GetChildren()) do
										...
										if ((L_839_[1]:FindFirstChild("HumanoidRootPart"))["Position"] - (CFrame["new"](-22695.7012, 5270.93652, 3814.42847, .11794927, 3.32185834e-08, .99301964, -8.73070718e-08, 1, -2.30819008e-08, -0.99301964, -8.3975138e-08, .11794927))["Position"])["Magnitude"] <= 300 then
											if L_839_[1]:FindFirstChild("HumanoidRootPart") and (L_839_[1]:FindFirstChild("Humanoid") and (L_839_[1]:FindFirstChild("Humanoid"))["Health"] > 0) then
												repeat
													wait()
													Attack["Kill"](L_839_[1], _G["CDK_TS"])
...
vars[93]["Quests"]:AddSection({
	"True Triple Katana Sword"
})
vars[93]["Quests"]:AddButton({
...
spawn(function()
	while wait(Sec) do
		if _G["Tp_LgS"] then
			pcall(function()
				for L_842_forvar0, L_843_forvar1 in pairs(replicated["NPCs"]:GetChildren()) do
					local L_844_ = {}
		...
		if _G["AutoPole"] then
			pcall(function()
				...
				if L_847_[2] then
					repeat
						task["wait"]()
						Attack["Kill"](L_847_[2], _G["AutoPole"])
		...
		pcall(function()
			if _G["AutoPoleV2"] then
				...
				elseif replicated["Remotes"]["CommF_"]:InvokeServer("Awakener", "Check") == nil or replicated["Remotes"]["CommF_"]:InvokeServer("Awakener", "Check") == 0 then
					...
					L_850_[1] = replicated["Remotes"]["CommF_"]:InvokeServer("RaidsNpc", "Select", _G["SelectChip"])
					if L_850_[1] then
						L_850_[1]:Stop()
					end
					_G["Raiding"] = true
		...
		pcall(function()
			if _G["AutoSaw"] then
				...
				if L_853_[2] then
					repeat
						task["wait"]()
						Attack["Kill"](L_853_[2], _G["AutoSaw"])
				...
				if workspace["Map"]["Jungle"]["Final"]["Part"]["Transparency"] == 0 then
								...
								elseif replicated["Remotes"]["CommF_"]:InvokeServer("ProQuestProgress", "RichSon") == 0 then
									if workspace["Enemies"]:FindFirstChild("Mob Leader") or replicated:FindFirstChild("Mob Leader") then
										...
										for L_856_forvar0, L_857_forvar1 in pairs(workspace["Enemies"]:GetChildren()) do
											...
											if L_858_[3]["Name"] == "Mob Leader" and Attack["Alive"](L_858_[3]) then
												repeat
													task["wait"]()
													Attack["Kill"](L_858_[3], _G["AutoSaber"])
					...
					if workspace["Enemies"]:FindFirstChild("Saber Expert") or replicated:FindFirstChild("Saber Expert") then
						for L_859_forvar0, L_860_forvar1 in pairs(workspace["Enemies"]:GetChildren()) do
							...
							if L_861_[1]["Name"] == "Saber Expert" and Attack["Alive"](L_861_[1]) then
								repeat
									task["wait"]()
									Attack["Kill"](L_861_[1], _G["AutoSaber"])
		...
		if _G["AutoColShad"] then
			pcall(function()
				...
				if L_864_[2] then
					repeat
						task["wait"]()
						Attack["Kill"](L_864_[2], _G["AutoColShad"])
		...
		pcall(function()
			if _G["AutoGetUsoap"] then
				for L_867_forvar0, L_868_forvar1 in pairs(workspace["Characters"]:GetChildren()) do
					...
					if L_869_[2]["Name"] ~= plr["Name"] then
			...
			pcall(function()
				...
				elseif GetWP("Bisento") then
					...
					if L_872_[1] then
						repeat
							wait()
							Attack["Kill"](L_872_[1], _G["Greybeard"])
		...
		if _G["WardenBoss"] then
			pcall(function()
				...
				if L_875_[2] then
					repeat
						wait()
						Attack["Kill"](L_875_[2], _G["WardenBoss"])
		...
		if _G["MarinesCoat"] then
			pcall(function()
				...
				if L_878_[2] then
					repeat
						wait()
						Attack["Kill"](L_878_[2], _G["MarinesCoat"])
		...
		if _G["SwanCoat"] then
			pcall(function()
				...
				if L_881_[2] then
					repeat
						wait()
						Attack["Kill"](L_881_[2], _G["SwanCoat"])
		...
		while wait(.1) do
			if _G["IceBossRen"] then
				...
				if L_884_[1] then
					repeat
						task["wait"]()
						Attack["Kill"](L_884_[1], _G["IceBossRen"])
...
spawn(function()
	while wait(.1) do
		pcall(function()
			if _G["KeysRen"] then
				if plr["Backpack"]:FindFirstChild(vars[138][3]) or plr["Character"]:FindFirstChild(vars[138][3]) then
					EquipWeapon(vars[138][3])
					wait(.1)
					_tp(CFrame["new"](6571.1201171875, 299.23028564453, -6967.841796875))
				else
					local L_887_ = {}
					L_887_[1] = GetConnectionEnemies(vars[138])
					if L_887_[1] then
						repeat
							task["wait"]()
							Attack["Kill"](L_887_[1], _G["KeysRen"])
						until plr["Backpack"]:FindFirstChild(vars[138][3]) or _G["KeysRen"] == false or not L_887_[1]["Parent"] or L_887_[1]["Humanoid"]["Health"] <= 0
					else
		...
		pcall(function()
			if _G["AutoTridentW2"] then
				...
				if L_890_[2] then
					repeat
						task["wait"]()
						Attack["Kill"](L_890_[2], _G["AutoTridentW2"])
		...
		pcall(function()
			if _G["LongsWord"] then
				...
				if L_893_[2] then
					repeat
						task["wait"]()
						Attack["Kill"](L_893_[2], _G["LongsWord"])
		...
		if _G["BlackSpikey"] then
			pcall(function()
				...
				if L_896_[1] then
					repeat
						wait()
						Attack["Kill"](L_896_[1], _G["BlackSpikey"])
			...
			if _G["AutoEcBoss"] then
				...
				elseif GetM("Ectoplasm") <= 99 then
					...
					if L_901_[1] then
						repeat
							wait()
							Attack["Kill"](L_901_[1], _G["AutoEcBoss"])
			...
			pcall(function()
				...
				elseif GetConnectionEnemies("Darkbeard") then
					...
					if L_904_[1] then
						repeat
							wait()
							Attack["Kill"](L_904_[1], _G["Auto_Def_DarkCoat"])
		...
		if _G["Auto_DonAcces"] then
			pcall(function()
				if (replicated["Remotes"]["CommF_"]:InvokeServer("GetUnlockables"))["FlamingoAccess"] == nil and plr["Data"]["Level"]["Value"] >= 1500 then
					FruitPrice = {}
					FruitStore = {}
					for L_907_forvar0, L_908_forvar1 in next, (replicated:WaitForChild("Remotes"))["CommF_"]:InvokeServer("GetFruits") do
						local L_909_ = {}
					...
					for L_910_forvar0, L_911_forvar1 in pairs(replicated["Remotes"]["CommF_"]:InvokeServer("getInventoryFruits")) do
						local L_912_ = {}
						...
						for L_916_forvar0, L_917_forvar1 in pairs(FruitPrice) do
							...
							for L_919_forvar0, L_920_forvar1 in pairs(FruitStore) do
								...
								if L_918_[3] == L_921_[2] and (replicated["Remotes"]["CommF_"]:InvokeServer("GetUnlockables"))["FlamingoAccess"] == nil then
									_G["StoreF"] = false
									if not plr["Backpack"]:FindFirstChild(FruitStore) then
										replicated["Remotes"]["CommF_"]:InvokeServer("LoadFruit", tostring(L_918_[3]))
									else
		...
		if _G["Auto_SwanGG"] then
			pcall(function()
				...
				if L_924_[2] then
					repeat
						wait()
						Attack["Kill"](L_924_[2], _G["Auto_SwanGG"])
		...
		if _G["AutoBigmom"] then
			pcall(function()
				...
				if L_927_[2] then
					repeat
						task["wait"]()
						Attack["Kill"](L_927_[2], _G["AutoBigmom"])
		...
		pcall(function()
			if _G["Auto_Cavender"] then
				...
				if L_930_[1] then
					repeat
						wait()
						Attack["Kill"](L_930_[1], _G["Auto_Cavender"])
		...
		pcall(function()
			if _G["TwinHook"] then
				...
				if L_933_[1] then
					repeat
						wait()
						Attack["Kill"](L_933_[1], _G["TwinHook"])
	...
	while wait(Sec) do
		if _G["AutoSerpentBow"] then
			...
			if L_936_[1] then
				repeat
					wait()
					Attack["Kill"](L_936_[1], _G["AutoSerpentBow"])
		...
		if _G["AutoKilo"] then
			pcall(function()
				...
				if L_939_[1] then
					repeat
						task["wait"]()
						Attack["Kill"](L_939_[1], _G["AutoKilo"])
...
spawn(function()
	while wait() do
		if _G["Tp_MasterA"] then
			pcall(function()
				for L_942_forvar0, L_943_forvar1 in pairs(replicated["NPCs"]:GetChildren()) do
					local L_944_ = {}
			...
			if _G["Auto_Rainbow_Haki"] then
				...
				elseif plr["PlayerGui"]["Main"]["Quest"]["Visible"] == true and string["find"](plr["PlayerGui"]["Main"]["Quest"]["Container"]["QuestTitle"]["Title"]["Text"], "Stone") then
					...
					if L_947_[1] then
						repeat
							wait()
							Attack["Kill"](L_947_[1], _G["Auto_Rainbow_Haki"])
						until _G["Auto_Rainbow_Haki"] == false or L_947_[1]["Humanoid"]["Health"] <= 0 or not L_947_[1]["Parent"] or plr["PlayerGui"]["Main"]["Quest"]["Visible"] == false
					else
				...
				elseif plr["PlayerGui"]["Main"]["Quest"]["Visible"] == true and string["find"](plr["PlayerGui"]["Main"]["Quest"]["Container"]["QuestTitle"]["Title"]["Text"], "Hydra Leader") then
					...
					if L_948_[2] then
						repeat
							task["wait"]()
							Attack["Kill"](L_948_[2], _G["Auto_Rainbow_Haki"])
						until _G["Auto_Rainbow_Haki"] == false or L_948_[2]["Humanoid"]["Health"] <= 0 or not L_948_[2]["Parent"] or plr["PlayerGui"]["Main"]["Quest"]["Visible"] == false
					else
						local L_949_ = {}
						...
						if plr["Character"]["HumanoidRootPart"]["CFrame"]["Position"] == L_949_[2] then
							_tp(L_949_[1])
						end
					end
				elseif plr["PlayerGui"]["Main"]["Quest"]["Visible"] == true and string["find"](plr["PlayerGui"]["Main"]["Quest"]["Container"]["QuestTitle"]["Title"]["Text"], "Kilo Admiral") then
					...
					if L_950_[2] then
						repeat
							task["wait"]()
							Attack["Kill"](L_950_[2], _G["Auto_Rainbow_Haki"])
						until _G["Auto_Rainbow_Haki"] == false or L_950_[2]["Humanoid"]["Health"] <= 0 or not L_950_[2]["Parent"] or plr["PlayerGui"]["Main"]["Quest"]["Visible"] == false
					else
				...
				elseif plr["PlayerGui"]["Main"]["Quest"]["Visible"] == true and string["find"](plr["PlayerGui"]["Main"]["Quest"]["Container"]["QuestTitle"]["Title"]["Text"], "Captain Elephant") then
					...
					if L_951_[2] then
						repeat
							task["wait"]()
							Attack["Kill"](L_951_[2], _G["Auto_Rainbow_Haki"])
						until _G["Auto_Rainbow_Haki"] == false or L_951_[2]["Humanoid"]["Health"] <= 0 or not L_951_[2]["Parent"] or plr["PlayerGui"]["Main"]["Quest"]["Visible"] == false
					else
						local L_952_ = {}
						...
						if plr["Character"]["HumanoidRootPart"]["CFrame"]["Position"] ~= L_952_[3] then
							replicated["Remotes"]["CommF_"]:InvokeServer("requestEntrance", Vector3["new"](-12471.169921875, 374.94024658203, -7551.677734375))
						elseif plr["Character"]["HumanoidRootPart"]["CFrame"]["Position"] == L_952_[3] then
							_tp(L_952_[1])
						end
					end
				elseif plr["PlayerGui"]["Main"]["Quest"]["Visible"] == true and string["find"](plr["PlayerGui"]["Main"]["Quest"]["Container"]["QuestTitle"]["Title"]["Text"], "Beautiful Pirate") then
					...
					if L_953_[2] then
						repeat
							task["wait"]()
							Attack["Kill"](L_953_[2], _G["Auto_Rainbow_Haki"])
						until _G["Auto_Rainbow_Haki"] == false or L_953_[2]["Humanoid"]["Health"] <= 0 or not L_953_[2]["Parent"] or plr["PlayerGui"]["Main"]["Quest"]["Visible"] == false
					else
			...
			pcall(function()
				...
				if plr["PlayerGui"]["Main"]["Quest"]["Visible"] == true and string["find"](plr["PlayerGui"]["Main"]["Quest"]["Container"]["QuestTitle"]["Title"]["Text"], "Defeat 50 Forest Pirates") then
					...
					if L_961_[1] then
						repeat
							wait()
							Attack["Kill"](L_961_[1], _G["AutoKenVTWO"])
						until not _G["AutoKenVTWO"] or L_961_[1]["Humanoid"]["Health"] <= 0 or plr["PlayerGui"]["Main"]["Quest"]["Visible"] == false
					else
						_tp(L_960_[2])
					end
				elseif plr["PlayerGui"]["Main"]["Quest"]["Visible"] == true then
					...
					if L_962_[1] then
						repeat
							wait()
							Attack["Kill"](L_962_[1], _G["AutoKenVTWO"])
						until not _G["AutoKenVTWO"] or L_962_[1]["Humanoid"]["Health"] <= 0 or plr["PlayerGui"]["Main"]["Quest"]["Visible"] == false
					else
						_tp(L_960_[4])
					end
				...
				if not plr["Backpack"]:FindFirstChild("Fruit Bowl") or not plr["Character"]:FindFirstChild("Fruit Bowl") then
						...
						if not GetBP("Apple") then
							...
							for L_963_forvar0, L_964_forvar1 in pairs(workspace:GetDescendants()) do
								...
								if L_965_[3]["Name"] == "Apple" then
									L_965_[3]["Handle"]["CFrame"] = plr["Character"]["HumanoidRootPart"]["CFrame"] * CFrame["new"](0, 1, 10)
									wait()
									firetouchinterest(plr["Character"]["HumanoidRootPart"], L_965_[3]["Handle"], 0)
									wait()
								end
							end
						elseif not GetBP("Banana") then
							...
							for L_966_forvar0, L_967_forvar1 in pairs(workspace:GetDescendants()) do
								...
								if L_968_[3]["Name"] == "Banana" then
									L_968_[3]["Handle"]["CFrame"] = plr["Character"]["HumanoidRootPart"]["CFrame"] * CFrame["new"](0, 1, 10)
									wait()
									firetouchinterest(plr["Character"]["HumanoidRootPart"], L_968_[3]["Handle"], 0)
									wait()
								end
							end
						elseif not GetBP("Pineapple") then
							...
							for L_969_forvar0, L_970_forvar1 in pairs(workspace:GetDescendants()) do
								...
								if L_971_[2]["Name"] == "Pineapple" then
									L_971_[2]["Handle"]["CFrame"] = plr["Character"]["HumanoidRootPart"]["CFrame"] * CFrame["new"](0, 1, 10)
									wait()
									firetouchinterest(plr["Character"]["HumanoidRootPart"], L_971_[2]["Handle"], 0)
									wait()
								end
							end
						end
					...
					if plr["Backpack"]:FindFirstChild("Banana") and (plr["Backpack"]:FindFirstChild("Apple") and plr["Backpack"]:FindFirstChild("Pineapple")) or plr:FindFirstChild("Banana") and (plr:FindFirstChild("Apple") and plr:FindFirstChild("Pineapple")) then
						repeat
							wait()
							_tp(L_960_[1])
						until _G["AutoKenVTWO"] or plr["Character"]["HumanoidRootPart"]["CFrame"] == L_960_[1]
						replicated["Remotes"]["CommF_"]:InvokeServer("CitizenQuestProgress", "Citizen")
					end
					if plr["Backpack"]:FindFirstChild("Fruit Bowl") or plr["Character"]:FindFirstChild("Fruit Bowl") then
						if plr["Character"]["HumanoidRootPart"]["CFrame"] ~= L_960_[3] then
							_tp(L_960_[3])
						elseif plr["Character"]["HumanoidRootPart"]["CFrame"] == L_960_[3] then
...
Bartilo = vars[93]["Quests"]:AddToggle({
	...
	while wait(.1) do
		pcall(function()
			if _G["Bartilo_Quest"] and Lv >= 850 then
				local L_974_ = {}
				L_974_[2] = plr["PlayerGui"]["Main"]["Quest"]
				if replicated["Remotes"]["CommF_"]:InvokeServer("BartiloQuestProgress", "Bartilo") == 0 then
					_G["Level"] = false
					if L_974_[2]["Visible"] == true then
						...
						if L_975_[1] then
							local L_976_ = {}
							L_976_[2] = GetConnectionEnemies(vars[81])
							if L_976_[2] then
								repeat
									task["wait"]()
									if not string["find"](plr["PlayerGui"]["Main"]["Quest"]["Container"]["QuestTitle"]["Title"]["Text"], "Swan Pirate") then
										...
										Attack["Kill"](L_976_[2], _G["Bartilo_Quest"])
									end
				...
				elseif replicated["Remotes"]["CommF_"]:InvokeServer("BartiloQuestProgress", "Bartilo") == 1 then
					...
					if L_977_[2] then
						repeat
							task["wait"]()
							Attack["Kill"](L_977_[2], _G["Bartilo_Quest"])
...
CitizenQ = vars[93]["Quests"]:AddToggle({
				...
				if Lv >= 1800 and (replicated["Remotes"]["CommF_"]:InvokeServer("CitizenQuestProgress"))["KilledBandits"] == false then
					if string["find"](plr["PlayerGui"]["Main"]["Quest"]["Container"]["QuestTitle"]["Title"]["Text"], "Forest Pirate") and (string["find"](plr["PlayerGui"]["Main"]["Quest"]["Container"]["QuestTitle"]["Title"]["Text"], "50") and plr["PlayerGui"]["Main"]["Quest"]["Visible"] == true) then
						...
						if L_980_[1] then
							repeat
								task["wait"]()
								Attack["Kill"](L_980_[1], _G["CitizenQuest"])
							until _G["CitizenQuest"] == false or not L_980_[1]["Parent"] or L_980_[1]["Humanoid"]["Health"] <= 0 or plr["PlayerGui"]["Main"]["Quest"]["Visible"] == false
						else
				...
				elseif Lv >= 1800 and (replicated["Remotes"]["CommF_"]:InvokeServer("CitizenQuestProgress"))["KilledBoss"] == false then
					...
					if plr["PlayerGui"]["Main"]["Quest"]["Visible"] and (string["find"](plr["PlayerGui"]["Main"]["Quest"]["Container"]["QuestTitle"]["Title"]["Text"], "Captain Elephant") and plr["PlayerGui"]["Main"]["Quest"]["Visible"] == true) then
						if L_981_[2] then
							repeat
								task["wait"]()
								Attack["Kill"](L_981_[2], _G["CitizenQuest"])
							until _G["CitizenQuest"] == false or L_981_[2]["Humanoid"]["Health"] <= 0 or not L_981_[2]["Parent"] or plr["PlayerGui"]["Main"]["Quest"]["Visible"] == false
						else
		...
		if _G["DummyMan"] then
			pcall(function()
				if plr["PlayerGui"]["Main"]["Quest"]["Visible"] == false then
					...
					((replicated:WaitForChild("Remotes")):WaitForChild("CommF_")):InvokeServer(unpack(L_984_[2]))
				else
					local L_985_ = {}
					...
					if L_985_[2] then
						repeat
							wait()
							Attack["Kill"](L_985_[2], _G["DummyMan"])
...
vars[93]["Quests"]:AddSection({
	"Fighting Melee Styles"
})
SuperHuman = vars[93]["Quests"]:AddToggle({
	...
	while wait(Sec) do
		pcall(function()
			if _G["Auto_SuperHuman"] then
				local L_988_ = {}
				L_988_[2] = plr["Data"]["Beli"]["Value"]
				L_988_[1] = plr["Data"]["Fragments"]["Value"]
...
DeathStep = vars[93]["Quests"]:AddToggle({
	["Name"] = "Auto DeathStep",
	["Description"] = "",
	["Default"] = false,
							...
							if workspace["Map"]["IceCastle"]["Hall"]["LibraryDoor"]["PhoeyuDoor"]["Transparency"] == 0 then
								...
								elseif not GetBP("Library Key") then
									...
									if L_991_[1] then
										repeat
											wait()
											Attack["Kill"](L_991_[1], _G["AutoDeathStep"])
...
SharkManV2 = vars[93]["Quests"]:AddToggle({
						...
						if GetBP("Fishman Karate") or (GetBP("Fishman Karate"))["Level"]["Value"] >= 400 then
							...
							elseif not GetBP("Water Key") then
								...
								if L_994_[2] then
									repeat
										wait()
										Attack["Kill"](L_994_[2], _G["Auto_SharkMan_Karate"])
...
ElectricClaw = vars[93]["Quests"]:AddToggle({
...
DragonTalon = vars[93]["Quests"]:AddToggle({
...
Godhuman = vars[93]["Quests"]:AddToggle({
	["Name"] = "Auto Godhuman",
	["Description"] = "";
	["Default"] = false;
...
SanguineArt = vars[93]["Quests"]:AddToggle({
					...
					if GetM("Vampire Fang") <= 19 then
						if World2 then
							...
							if L_1003_[1] then
								repeat
									task["wait"]()
									Attack["Kill"](L_1003_[1], _G["Snaguine"])
					...
					if GetM("Vampire Fang") >= 20 and GetM("Demonic Wisp") <= 19 then
						if World3 then
							...
							if L_1004_[1] then
								repeat
									task["wait"]()
									Attack["Kill"](L_1004_[1], _G["Snaguine"])
...
vars[93]["Race"]:AddSection({
	"Mystic Island / Full Moon"
})
FullMOOn = vars[93]["Race"]:AddParagraph({
	["Title"] = " FullMoon Status ";
	["Content"] = ""
})
Ismirage = vars[93]["Race"]:AddParagraph({
			...
			pcall(function()
				if not workspace["_WorldOrigin"]["Locations"]:FindFirstChild("Mirage Island", true) then
					...
					if not L_1008_[1] then
						...
						if (L_1009_[1]["Position"] - plr["Character"]["HumanoidRootPart"]["Position"])["Magnitude"] <= 10 then
						...
						if plr["Character"]["Humanoid"]["Sit"] == false then
							...
							until not _G["FindMirage"] or (L_1011_[1]["Position"] - plr["Character"]["HumanoidRootPart"]["Position"])["Magnitude"] <= 10 or workspace["_WorldOrigin"]["Locations"]:FindFirstChild("Mirage Island") or plr["Character"]["Humanoid"]["Sit"] == false
...
spawn(function()
	while wait() do
		if _G["Addealer"] then
			pcall(function()
				for L_1033_forvar0, L_1034_forvar1 in pairs(replicated["NPCs"]:GetChildren()) do
					local L_1035_ = {}
					L_1035_[3], L_1035_[1] = L_1033_forvar0, L_1034_forvar1
					if L_1035_[1]["Name"] == "Advanced Fruit Dealer" then
...
function MoveCamtoMoon()
	...
	plr["Character"]["HumanoidRootPart"]["CFrame"] = CFrame["new"](plr["Character"]["HumanoidRootPart"]["Position"], plr["Character"]["HumanoidRootPart"]["Position"] + L_1045_[2])
end
task["spawn"](function()
	while task["wait"](.1) do
		if LookMV3 then
...
RaceMink = vars[93]["Race"]:AddToggle({
					...
					elseif replicated["Remotes"]["CommF_"]:InvokeServer("Alchemist", "1") == 1 then
						...
						elseif not plr["Backpack"]:FindFirstChild("Flower 3") and not plr["Character"]:FindFirstChild("Flower 3") then
							...
							if L_1048_[2] then
								repeat
									wait()
									Attack["Kill"](L_1048_[2], _G["Auto_Mink"])
...
RaceHuman = vars[93]["Race"]:AddToggle({
	...
	while wait(Sec) do
		pcall(function()
			if _G["Auto_Human"] then
					...
					elseif replicated["Remotes"]["CommF_"]:InvokeServer("Alchemist", "1") == 1 then
						...
						elseif not plr["Backpack"]:FindFirstChild("Flower 3") and not plr["Character"]:FindFirstChild("Flower 3") then
							...
							if L_1051_[1] then
								repeat
									wait()
									Attack["Kill"](L_1051_[1], _G["Auto_Human"])
								until plr["Backpack"]:FindFirstChild("Flower 3") or not L_1051_[1]["Parent"] or L_1051_[1]["Humanoid"]["Health"] <= 0 or _G["Auto_Human"] == false
							else
								_tp(CFrame["new"](980.09851074219, 121.33129882812, 1287.2093505859))
							end
						end
				...
				elseif replicated["Remotes"]["CommF_"]:InvokeServer("Wenlocktoad", "1") == 1 then
					local L_1052_ = {}
					L_1052_[1] = GetConnectionEnemies(vars[110][1])
					if L_1052_[1] then
						repeat
							wait()
							Attack["Kill"](L_1052_[1], _G["Auto_Human"])
					...
					L_1052_[4] = GetConnectionEnemies(vars[110][2])
					if L_1052_[4] then
						repeat
							wait()
							Attack["Kill"](L_1052_[4], _G["Auto_Human"])
						until L_1052_[4]["Humanoid"]["Health"] <= 0 or not L_1052_[4]["Parent"] or not _G["Auto_Human"]
					else
						_tp(CFrame["new"](2006.9261474609, 448.95666503906, 853.98284912109))
					end
					L_1052_[3] = GetConnectionEnemies(vars[110][3])
					if L_1052_[3] then
						repeat
							wait()
							Attack["Kill"](L_1052_[3], _G["Auto_Human"])
...
RaceSky = vars[93]["Race"]:AddToggle({
			...
			if _G["Auto_Skypiea"] then
					...
					elseif replicated["Remotes"]["CommF_"]:InvokeServer("Alchemist", "1") == 1 then
						...
						elseif not plr["Backpack"]:FindFirstChild("Flower 3") and not plr["Character"]:FindFirstChild("Flower 3") then
							...
							if L_1055_[1] then
								repeat
									wait()
									Attack["Kill"](L_1055_[1], _G["Auto_Skypiea"])
								until plr["Backpack"]:FindFirstChild("Flower 3") or not L_1055_[1]["Parent"] or L_1055_[1]["Humanoid"]["Health"] <= 0 or _G["Auto_Skypiea"] == false
							else
								_tp(CFrame["new"](980.09851074219, 121.33129882812, 1287.2093505859))
							end
						end
				...
				elseif replicated["Remotes"]["CommF_"]:InvokeServer("Wenlocktoad", "1") == 1 then
					for L_1056_forvar0, L_1057_forvar1 in pairs(game["Players"]:GetChildren()) do
						...
						if L_1058_[1]["Name"] ~= plr["Name"] and tostring(L_1058_[1]["Data"]["Race"]["Value"]) == "Skypiea" then
							repeat
								task["wait"]()
...
RaceFish = vars[93]["Race"]:AddToggle({
					...
					elseif replicated["Remotes"]["CommF_"]:InvokeServer("Alchemist", "1") == 1 then
						...
						elseif not plr["Backpack"]:FindFirstChild("Flower 3") and not plr["Character"]:FindFirstChild("Flower 3") then
							...
							if L_1061_[1] then
								repeat
									wait()
									Attack["Kill"](L_1061_[1], _G["Auto_Fish"])
								until plr["Backpack"]:FindFirstChild("Flower 3") or not L_1061_[1]["Parent"] or L_1061_[1]["Humanoid"]["Health"] <= 0 or _G["Auto_Fish"] == false
							else
								_tp(CFrame["new"](980.09851074219, 121.33129882812, 1287.2093505859))
							end
						end
...
CheckTier = vars[93]["Race"]:AddParagraph({
				...
				for L_1070_forvar0 = 1, #L_1069_[2], 1 do
					...
					elseif (plr["Character"]:FindFirstChild("RaceTransformed"))["Value"] == false then
						...
						if L_1071_[1] then
							repeat
								wait()
								Attack["Kill"](L_1071_[1], _G["AcientOne"])
			...
			if _G["Complete_Trials"] then
				if tostring(plr["Data"]["Race"]["Value"]) == "Human" or tostring(plr["Data"]["Race"]["Value"]) == "Ghoul" then
					...
					if L_1085_[3] then
						repeat
							wait()
							Attack["Kill"](L_1085_[3], _G["Complete_Trials"])
...
AutoKill = vars[93]["Race"]:AddToggle({
		...
		pcall(function()
			if _G["Defeating"] then
				for L_1088_forvar0, L_1089_forvar1 in pairs(workspace["Characters"]:GetChildren()) do
					...
					if L_1090_[1]["Name"] ~= plr["Name"] then
...
vars[93]["Prehistoric"]:AddSection({
	"Dojo Quest"
})
vars[93]["Prehistoric"]:AddButton({
...
DojoQ = vars[93]["Prehistoric"]:AddToggle({
	...
	while wait(Sec) do
		if _G["Dojoo"] then
			pcall(function()
				...
				L_1095_[4] = (replicated["Modules"]["Net"]:FindFirstChild("RF/InteractDragonQuest")):InvokeServer(unpack(L_1095_[3]))
				...
				elseif debug == true and ((CFrame["new"](5865.0234375, 1208.3154296875, 871.15185546875))["Position"] - plr["Character"]["HumanoidRootPart"]["Position"])["Magnitude"] <= 50 then
					if L_1095_[1] == "White" then
						...
						if L_1096_[1] then
							repeat
								task["wait"]()
								Attack["Kill"](L_1096_[1], _G["Dojoo"])
							until not L_1095_[4] or not _G["Dojoo"] or not Attack["Alive"](L_1096_[1])
						else
				...
				if not L_1095_[4] then
					...
					(replicated["Modules"]["Net"]:FindFirstChild("RF/InteractDragonQuest")):InvokeServer(unpack(L_1097_[2]))
				end
			end)
		end
	end
end)
BlazeEM = vars[93]["Prehistoric"]:AddToggle({
...
BackTODoJo = function()
	for L_1107_forvar0, L_1108_forvar1 in pairs((game:GetService("Players"))["LocalPlayer"]["PlayerGui"]["Notifications"]:GetChildren()) do
		...
		if L_1109_[1]["Name"] == "NotificationTemplate" then
			if string["find"](L_1109_[1]["Text"], "Head back to the Dojo to complete more tasks") then
				return true
			end
		end
	end
...
DragonMobClear = function(L_1110_arg0, L_1111_arg1, L_1112_arg2)
	...
	if workspace["Enemies"]:FindFirstChild(L_1113_[4]) then
		for L_1114_forvar0, L_1115_forvar1 in pairs(workspace["Enemies"]:GetChildren()) do
			...
			if L_1116_[3]["Name"] == L_1113_[4] and Attack["Alive"](L_1116_[3]) then
				if L_1113_[3] then
					Attack["Kill"](L_1116_[3], L_1113_[3])
				end
			end
		end
	else
...
GetQuestDracoLevel = function()
	...
	return (replicated["Modules"]["Net"]:FindFirstChild("RF/InteractDragonQuest")):InvokeServer(unpack(L_1118_[1]))
end
Toggle = vars[93]["Prehistoric"]:AddToggle({
			...
			if _G["UPGDrago"] then
				...
				elseif GetQuestDracoLevel() == true then
					if ((CFrame["new"](5814.4272460938, 1208.3267822266, 884.57855224609))["Position"] - Root["Position"])["Magnitude"] >= 300 then
						...
						(replicated["Modules"]["Net"]:FindFirstChild("RF/InteractDragonQuest")):InvokeServer(unpack(L_1121_[1]))
					end
				end
			end
		end)
...
fireflower = vars[93]["Prehistoric"]:AddToggle({
	["Name"] = "Auto Drago (V2)";
	["Description"] = "";
	["Default"] = false;
	...
	while wait(Sec) do
		if _G["AutoFireFlowers"] then
			...
			if L_1126_[2] then
				repeat
					wait()
					Attack["Kill"](L_1126_[2], _G["AutoFireFlowers"])
				...
				for L_1139_forvar0 = 1, #L_1138_[2], 1 do
					...
					elseif (plr["Character"]:FindFirstChild("RaceTransformed"))["Value"] == false then
						...
						if L_1140_[1] then
							repeat
								wait()
								Attack["Kill"](L_1140_[1], _G["TrainDrago"])
...
dragoTpVolcano = vars[93]["Prehistoric"]:AddToggle({
...
bdrago = vars[93]["Prehistoric"]:AddToggle({
		...
		if _G["BuyDrago"] then
			pcall(function()
				if ((CFrame["new"](5814.4272460938, 1208.3267822266, 884.57855224609))["Position"] - Root["Position"])["Magnitude"] >= 300 then
					...
					(replicated["Modules"]["Net"]:FindFirstChild("RF/InteractDragonQuest")):InvokeServer(unpack(L_1146_[1]))
				end
			end)
		end
	end
end)
UpTalon = vars[93]["Prehistoric"]:AddToggle({
...
spawn(function()
	while wait(Sec) do
		if _G["DT_Uzoth"] then
			...
			_tp(L_1149_[2])
			if (L_1149_[2]["Position"] - plr["Character"]["HumanoidRootPart"]["Position"])["Magnitude"] <= 25 then
				local L_1150_ = {}
				L_1150_[2] = {
					["NPC"] = "Uzoth",
					["Command"] = "Upgrade"
				}
				replicated["Modules"]["Net"]["RF/InteractDragonQuest"]:InvokeServer(L_1150_[2])
			end
		end
	end
end)
...
Check_Volcano = vars[93]["Prehistoric"]:AddParagraph({
				...
				if L_1170_[2] then
					if workspace["Map"]:FindFirstChild("PrehistoricIsland", true) then
						...
						if L_1171_[1] and L_1171_[1]:FindFirstChild("ProximityPrompt") then
							if plr:DistanceFromCharacter(L_1171_[1]["CFrame"]["Position"]) <= 150 then
				...
				for L_1184_forvar0, L_1185_forvar1 in pairs(L_1183_[1]:GetChildren()) do
					...
					if L_1186_[4] and L_1186_[4]["Enabled"] then
						repeat
							...
							if plr:DistanceFromCharacter(L_1186_[2]["CFrame"]["Position"]) <= 150 then
...
Kaura = vars[93]["Prehistoric"]:AddToggle({
	["Name"] = "Kill Aura";
	["Description"] = "",
	["Default"] = false;
			...
			pcall(function()
				...
				for L_1190_forvar0, L_1191_forvar1 in pairs(workspace["Enemies"]:GetChildren()) do
					...
					if L_1192_[2]:FindFirstChild("Humanoid") and L_1192_[2]:FindFirstChild("HumanoidRootPart") then
						...
						if L_1193_[1] <= vars[53] and L_1192_[2]["Humanoid"]["Health"] > 0 then
...
Vocan = vars[93]["Prehistoric"]:AddToggle({
...
vars[93]["SeaEvent"]:AddSection({
	"Sea Event / Setting Sail"
})
vars[130] = {
	"Guardian",
	"PirateGrandBrigade";
...
Q = vars[93]["SeaEvent"]:AddDropdown({
	["Name"] = "Select Boats",
	["Options"] = vars[130],
	["Default"] = false;
		...
		if _G["SailBoats"] then
			pcall(function()
				...
				if not L_1240_[2] and (not(CheckShark() and _G["Shark"] or CheckTerrorShark() and _G["TerrorShark"] or CheckFishCrew() and _G["MobCrew"] or CheckPiranha() and _G["Piranha"]) and (not(CheckEnemiesBoat() and _G["FishBoat"]) and (not(CheckSeaBeast() and _G["SeaBeast1"]) and (not(_G["PGB"] and CheckPirateGrandBrigade()) and (not(_G["HCM"] and CheckHauntedCrew()) and not(_G["Leviathan1"] and CheckLeviathan())))))) then
					...
					if (L_1241_[1]["Position"] - plr["Character"]["HumanoidRootPart"]["Position"])["Magnitude"] <= 10 then
						replicated["Remotes"]["CommF_"]:InvokeServer("BuyBoat", _G["SelectedBoat"])
					end
				...
				if CheckShark() then
					for L_1266_forvar0, L_1267_forvar1 in pairs(workspace["Enemies"]:GetChildren()) do
						...
						if table["find"](L_1265_[2], L_1268_[3]["Name"]) then
							if Attack["Alive"](L_1268_[3]) then
								repeat
									task["wait"]()
									Attack["Kill"](L_1268_[3], _G["Shark"])
				...
				if CheckTerrorShark() then
					for L_1270_forvar0, L_1271_forvar1 in pairs(workspace["Enemies"]:GetChildren()) do
						...
						if table["find"](L_1269_[2], L_1272_[1]["Name"]) then
							if Attack["Alive"](L_1272_[1]) then
								repeat
									task["wait"]()
									Attack["KillSea"](L_1272_[1], _G["TerrorShark"])
				...
				if CheckPiranha() then
					for L_1274_forvar0, L_1275_forvar1 in pairs(workspace["Enemies"]:GetChildren()) do
						...
						if table["find"](L_1273_[1], L_1276_[2]["Name"]) then
							if Attack["Alive"](L_1276_[2]) then
								repeat
									task["wait"]()
									Attack["Kill"](L_1276_[2], _G["Piranha"])
				...
				if CheckFishCrew() then
					for L_1278_forvar0, L_1279_forvar1 in pairs(workspace["Enemies"]:GetChildren()) do
						...
						if table["find"](L_1277_[2], L_1280_[1]["Name"]) then
							if Attack["Alive"](L_1280_[1]) then
								repeat
									task["wait"]()
									Attack["Kill"](L_1280_[1], _G["MobCrew"])
				...
				if CheckHauntedCrew() then
					for L_1282_forvar0, L_1283_forvar1 in pairs(workspace["Enemies"]:GetChildren()) do
						...
						if table["find"](L_1281_[1], L_1284_[3]["Name"]) then
							if Attack["Alive"](L_1284_[3]) then
								repeat
									task["wait"]()
									Attack["Kill"](L_1284_[3], _G["HCM"])
					...
					for L_1285_forvar0, L_1286_forvar1 in pairs(workspace["SeaBeasts"]:GetChildren()) do
						...
						if L_1287_[3]:FindFirstChild("HumanoidRootPart") and (L_1287_[3]:FindFirstChild("Health") and L_1287_[3]["Health"]["Value"] > 0) then
							repeat
								...
								if plr:DistanceFromCharacter(L_1287_[3]["HumanoidRootPart"]["CFrame"]["Position"]) <= 500 then
					...
					for L_1288_forvar0, L_1289_forvar1 in pairs(workspace["SeaBeasts"]:GetChildren()) do
						...
						if L_1290_[3]:FindFirstChild("HumanoidRootPart") and (L_1290_[3]:FindFirstChild("Leviathan Segment") and (L_1290_[3]:FindFirstChild("Health") and L_1290_[3]["Health"]["Value"] > 0)) then
							repeat
								...
								if plr:DistanceFromCharacter(L_1290_[3]["HumanoidRootPart"]["CFrame"]["Position"]) <= 500 then
					...
					for L_1291_forvar0, L_1292_forvar1 in pairs(workspace["Enemies"]:GetChildren()) do
						...
						if L_1293_[2]:FindFirstChild("Health") and (L_1293_[2]["Health"]["Value"] > 0 and L_1293_[2]:FindFirstChild("VehicleSeat")) then
							repeat
								...
								if plr:DistanceFromCharacter(L_1293_[2]["Engine"]["CFrame"]["Position"]) <= 150 then
					...
					for L_1294_forvar0, L_1295_forvar1 in pairs(workspace["Enemies"]:GetChildren()) do
						...
						if L_1296_[2]:FindFirstChild("Health") and (L_1296_[2]["Health"]["Value"] > 0 and L_1296_[2]:FindFirstChild("VehicleSeat")) then
							repeat
								...
								if plr:DistanceFromCharacter(L_1296_[2]["Engine"]["CFrame"]["Position"]) <= 150 then
...
vars[93]["SeaEvent"]:AddSection({
	"Kitsune Island / Event"
})
Check_Kitsu = vars[93]["SeaEvent"]:AddParagraph({
			...
			pcall(function()
				if not workspace["_WorldOrigin"]["Locations"]:FindFirstChild("Kitsune Island", true) then
					...
					if not L_1299_[2] then
						...
						if (L_1300_[1]["Position"] - plr["Character"]["HumanoidRootPart"]["Position"])["Magnitude"] <= 10 then
							replicated["Remotes"]["CommF_"]:InvokeServer("BuyBoat", _G["SelectedBoat"])
						end
					else
						if plr["Character"]["Humanoid"]["Sit"] == false then
							...
							until not _G["AutofindKitIs"] or (L_1302_[2]["Position"] - plr["Character"]["HumanoidRootPart"]["Position"])["Magnitude"] <= 10 or workspace["_WorldOrigin"]["Locations"]:FindFirstChild("Kitsune Island") or plr["Character"]["Humanoid"]["Sit"] == false
							plr["Character"]["Humanoid"]["Sit"] = false
						end
					end
				else
...
vars[93]["SeaEvent"]:AddSection({
	"Frozen Dimension Event"
})
vars[93]["SeaEvent"]:AddParagraph({
...
spawn(function()
	while wait(.2) do
		pcall(function()
			local L_1313_ = {}
			L_1313_[1] = string["match"](replicated["Remotes"]["CommF_"]:InvokeServer("InfoLeviathan", "1"), "%d+")
			if L_1313_[1] then
		...
		if _G["SailBoat_Hydra"] then
			pcall(function()
				...
				if not L_1318_[2] then
					...
					if (L_1319_[2]["Position"] - plr["Character"]["HumanoidRootPart"]["Position"])["Magnitude"] <= 10 then
						replicated["Remotes"]["CommF_"]:InvokeServer("BuyBoat", _G["SelectedBoat"])
					end
...
vars[67] = function(L_1325_arg0)
	local L_1326_ = {}
	L_1326_[2] = L_1325_arg0
	return math["floor"](tonumber(L_1326_[2]) + .5)
end
Number = math["random"](1, 1000000)
vars[23] = (game:GetService("Players"))["LocalPlayer"]
vars[55] = game:GetService("ReplicatedStorage")
vars[86] = vars[23]["Team"]
EspPly = function()
...
" .. (vars[67]((vars[23]["Character"]["Head"]["Position"] - L_1329_[2]["Character"]["Head"]["Position"])["Magnitude"] / 3) .. " M"))
						L_1330_[3]["Size"] = UDim2["new"](1, 0, 1, 0)
						L_1330_[3]["TextYAlignment"] = "Top"
						L_1330_[3]["BackgroundTransparency"] = 1
						L_1330_[3]["TextStrokeTransparency"] = .5
						if L_1329_[2]["Team"] == vars[86] then
						...
						if L_1329_[2]["Character"]["Head"]:FindFirstChild("NameEsp" .. Number) then
							L_1329_[2]["Character"]["Head"]["NameEsp" .. Number]["TextLabel"]["Text"] = L_1329_[2]["Name"] .. (" | " .. (vars[67]((vars[23]["Character"]["Head"]["Position"] - L_1329_[2]["Character"]["Head"]["Position"])["Magnitude"] / 3) .. (" M\
Health : " .. (vars[67]((L_1329_[2]["Character"]["Humanoid"]["Health"] * 100) / L_1329_[2]["Character"]["Humanoid"]["MaxHealth"]) .. "%"))))
						end
					end
				else
					if L_1329_[2]["Character"]["Head"]:FindFirstChild("NameEsp" .. Number) then
			...
			if IslandESP then
				if L_1333_[2]["Name"] ~= "Sea" then
					if not L_1333_[2]:FindFirstChild("NameEsp") then
						...
						L_1334_[3]["BackgroundTransparency"] = 1
						L_1334_[3]["TextStrokeTransparency"] = .5
						L_1334_[3]["TextColor3"] = Color3["fromRGB"](98, 252, 252)
						L_1334_[3]["Text"] = L_1333_[2]["Name"] .. ("   \
" .. (vars[67]((vars[23]["Character"]["Head"]["Position"] - L_1333_[2]["Position"])["Magnitude"] / 3) .. " M"))
					else
			...
			if DevilFruitESP then
				if string["find"](L_1337_[3]["Name"], "Fruit") then
					if not L_1337_[3]["Handle"]:FindFirstChild("NameEsp" .. Number) then
						...
						L_1338_[3]["BackgroundTransparency"] = 1
						L_1338_[3]["TextStrokeTransparency"] = .5
						L_1338_[3]["TextColor3"] = Color3["fromRGB"](255, 255, 255)
						L_1338_[3]["Text"] = L_1337_[3]["Name"] .. (" \
" .. (vars[67]((vars[23]["Character"]["Head"]["Position"] - L_1337_[3]["Handle"]["Position"])["Magnitude"] / 3) .. " M"))
					else
			...
			if L_1341_[1]["Name"] == "Flower2" or L_1341_[1]["Name"] == "Flower1" then
				if FlowerESP then
					if not L_1341_[1]:FindFirstChild("NameEsp" .. Number) then
						...
						L_1342_[1]["BackgroundTransparency"] = 1
						L_1342_[1]["TextStrokeTransparency"] = .5
						L_1342_[1]["TextColor3"] = Color3["fromRGB"](88, 214, 252)
						if L_1341_[1]["Name"] == "Flower1" then
							L_1342_[1]["Text"] = "Blue Flower" .. (" \
" .. (vars[67]((vars[23]["Character"]["Head"]["Position"] - L_1341_[1]["Position"])["Magnitude"] / 3) .. " M"))
			...
			if EspEventIsland then
				if L_1345_[1]["Name"] == "Mirage Island" or L_1345_[1]["Name"] == "Prehistoric Island" or L_1345_[1]["Name"] == "Kitsune Island" then
					if not L_1345_[1]:FindFirstChild("NameEsp") then
						...
						L_1346_[2]["BackgroundTransparency"] = 1
						L_1346_[2]["TextStrokeTransparency"] = .5
						L_1346_[2]["TextColor3"] = Color3["fromRGB"](80, 245, 245)
						L_1346_[2]["Text"] = L_1345_[1]["Name"] .. ("   \
" .. (vars[67]((vars[23]["Character"]["Head"]["Position"] - L_1345_[1]["Position"])["Magnitude"] / 3) .. " M"))
					else
			...
			if ESPGear then
				if L_1349_[1]["Name"] == "Part" and L_1349_[1]["Material"] == Enum["Material"]["Neon"] then
					if not L_1349_[1]:FindFirstChild("NameEsp") then
						...
						L_1350_[1]["BackgroundTransparency"] = 1
						L_1350_[1]["TextStrokeTransparency"] = .5
						L_1350_[1]["TextColor3"] = Color3["fromRGB"](80, 245, 245)
						L_1350_[1]["Text"] = "Gear" .. ("   \
" .. (vars[67]((vars[23]["Character"]["Head"]["Position"] - L_1349_[1]["Position"])["Magnitude"] / 3) .. " M"))
					else
...
AdvanFruitEsp = function()
	if advanEsp then
		for L_1351_forvar0, L_1352_forvar1 in pairs(vars[55]["NPCs"]:GetChildren()) do
			local L_1353_ = {}
			L_1353_[3], L_1353_[1] = L_1351_forvar0, L_1352_forvar1
			if L_1353_[1]["Name"] == "Advanced Fruit Dealer" then
				...
				elseif workspace:FindFirstChild("Adv") then
					if not Adv:FindFirstChild("NameEsp") then
						...
						L_1354_[2]["BackgroundTransparency"] = 1
						L_1354_[2]["TextStrokeTransparency"] = .5
						L_1354_[2]["TextColor3"] = Color3["fromRGB"](80, 245, 245)
						L_1354_[2]["Text"] = L_1353_[1]["Name"] .. ("   \
" .. (vars[67]((vars[23]["Character"]["Head"]["Position"] - L_1353_[1]["HumanoidRootPart"]["Position"])["Magnitude"] / 3) .. " M"))
					else
...
HakiClorEsp = function()
	if ColorEsp then
		for L_1355_forvar0, L_1356_forvar1 in pairs(vars[55]["NPCs"]:GetChildren()) do
			local L_1357_ = {}
			...
			if L_1357_[1]["Name"] == "Barista Cousin" then
				...
				elseif workspace:FindFirstChild("Gay") then
					if not Gay:FindFirstChild("NameEsp") then
						...
						L_1358_[2]["BackgroundTransparency"] = 1
						L_1358_[2]["TextStrokeTransparency"] = .5
						L_1358_[2]["TextColor3"] = Color3["fromRGB"](80, 245, 245)
						L_1358_[2]["Text"] = L_1357_[1]["Name"] .. ("   \
" .. (vars[67]((vars[23]["Character"]["Head"]["Position"] - L_1357_[1]["HumanoidRootPart"]["Position"])["Magnitude"] / 3) .. " M"))
					else
...
LegenSword = function()
	if LegenS then
		for L_1359_forvar0, L_1360_forvar1 in pairs(vars[55]["NPCs"]:GetChildren()) do
			local L_1361_ = {}
			L_1361_[3], L_1361_[2] = L_1359_forvar0, L_1360_forvar1
			if L_1361_[2]["Name"] == "Legendary Sword Dealer" then
				...
				elseif workspace:FindFirstChild("Lgd") then
					if not Lgd:FindFirstChild("NameEsp") then
						...
						L_1362_[1]["BackgroundTransparency"] = 1
						L_1362_[1]["TextStrokeTransparency"] = .5
						L_1362_[1]["TextColor3"] = Color3["fromRGB"](80, 245, 245)
						L_1362_[1]["Text"] = L_1361_[2]["Name"] .. ("   \
" .. (vars[67]((vars[23]["Character"]["Head"]["Position"] - L_1361_[2]["HumanoidRootPart"]["Position"])["Magnitude"] / 3) .. " M"))
					else
	...
	if ChestESP then
		...
		for L_1364_forvar0, L_1365_forvar1 in ipairs(L_1363_[3]) do
			...
			pcall(function()
				...
				L_1367_[5] = (L_1367_[3] - vars[23]["Character"]["Head"]["Position"])["Magnitude"]
			...
			pcall(function()
				...
				for L_1378_forvar0, L_1379_forvar1 in pairs(L_1376_[2]:GetAttributes()) do
					...
					if L_1380_[2] then
						...
						L_1381_[4] = (vars[23]["Character"]["Head"]["Position"] - L_1377_[1])["Magnitude"] / 3
						if L_1381_[3] then
...
vars[93]["Raids"]:AddSection({
	"Fruits Options"
})
vars[88] = function(L_1432_arg0)
	local L_1433_ = {}
...
"
	...
	if not L_1435_[5] or not L_1435_[3] then
		L_1435_[1] = L_1435_[1] .. "- Error while retrieving data.\\
"
	else
		local L_1436_ = {}
		L_1436_[1] = false
		for L_1437_forvar0, L_1438_forvar1 in pairs(L_1435_[3]) do
			...
			if L_1439_[3]["OnSale"] then
				L_1436_[1] = true
				L_1435_[1] = L_1435_[1] .. (L_1439_[3]["Name"] .. (" - $" .. (vars[88](L_1439_[3]["Price"]) .. "\
")))
			end
		end
	...
	if L_1435_[4] and L_1435_[6] then
		...
		for L_1441_forvar0, L_1442_forvar1 in pairs(L_1435_[6]) do
			...
			if L_1443_[2]["OnSale"] then
				L_1440_[2] = true
				L_1435_[1] = L_1435_[1] .. (L_1443_[2]["Name"] .. (" - $" .. (vars[88](L_1443_[2]["Price"]) .. "\
")))
			end
		end
...
stockParagraph = vars[93]["Raids"]:AddParagraph({
	["Title"] = "Stock Fruit";
	["Content"] = "Loading..."
})
task["spawn"](function()
...
RandomFF = vars[93]["Raids"]:AddToggle({
	...
	while wait(Sec) do
		pcall(function()
			if _G["Random_Auto"] then
				vars[55]["Remotes"]["CommF_"]:InvokeServer("Cousin", "Buy")
			end
		end)
	end
end)
DropF = vars[93]["Raids"]:AddToggle({
...
StoredF = vars[93]["Raids"]:AddToggle({
...
BringF = vars[93]["Raids"]:AddToggle({
...
vars[93]["Raids"]:AddSection({
	"Dungeon Event / Raiding"
})
RaidS = vars[93]["Raids"]:AddParagraph({
...
spawn(function()
	while wait(.2) do
		pcall(function()
			if vars[23]["PlayerGui"]["Main"]["Timer"]["Visible"] == true then
...
vars[93]["Raids"]:AddButton({
	["Name"] = "Buy Dungeon Chips [Beli]",
	["Description"] = "";
	["Callback"] = function()
		if not GetBP("Special Microchip") then
			vars[55]["Remotes"]["CommF_"]:InvokeServer("RaidsNpc", "Select", _G["SelectChip"])
		end
	end
})
vars[93]["Raids"]:AddButton({
	...
	["Callback"] = function()
		...
		L_1471_[2] = {}
		L_1471_[1] = {}
		for L_1472_forvar0, L_1473_forvar1 in next, (vars[55]:WaitForChild("Remotes"))["CommF_"]:InvokeServer("GetFruits") do
			local L_1474_ = {}
		...
		for L_1475_forvar0, L_1476_forvar1 in pairs(L_1471_[2]) do
			...
			for L_1478_forvar0, L_1479_forvar1 in pairs(vars[15]) do
				if not GetBP("Special Microchip") then
					vars[55]["Remotes"]["CommF_"]:InvokeServer("LoadFruit", tostring(L_1477_[2]))
					vars[55]["Remotes"]["CommF_"]:InvokeServer("RaidsNpc", "Select", _G["SelectChip"])
				end
			end
		end
...
AutoChipBeli = vars[93]["Raids"]:AddToggle({
...
AutoChipFruit = vars[93]["Raids"]:AddToggle({
	...
	while task["wait"](1) do
		if _G["AutoChipFruit"] then
			pcall(function()
				if not GetBP("Special Microchip") then
					local L_1484_ = {}
					L_1484_[3] = vars[55]["Remotes"]["CommF_"]:InvokeServer("GetFruits")
					L_1484_[2] = nil
					...
					if L_1484_[2] then
						vars[55]["Remotes"]["CommF_"]:InvokeServer("LoadFruit", tostring(L_1484_[2]))
						vars[55]["Remotes"]["CommF_"]:InvokeServer("RaidsNpc", "Select", _G["SelectChip"])
					end
				end
			end)
...
StartR = vars[93]["Raids"]:AddToggle({
...
Raiding = vars[93]["Raids"]:AddToggle({
...
spawn(function()
	...
	while task["wait"](.3) do
		...
		L_1496_[8] = vars[23]["PlayerGui"]["Main"]["TopHUDList"]["RaidTimer"]
		if not L_1496_[8]["Visible"] then
			continue
		end
		L_1496_[1] = vars[23]["Character"]
		...
		for L_1501_forvar0, L_1502_forvar1 in ipairs(workspace["Enemies"]:GetChildren()) do
			...
			if L_1503_[2] and (L_1503_[1] and L_1503_[2]["Health"] > 0) then
				if (L_1503_[1]["Position"] - L_1496_[3]["Position"])["Magnitude"] < 450 then
					...
					repeat
						task["wait"]()
						Attack["Kill"](L_1503_[3], _G["Raiding"])
	...
	while wait(Sec) do
		pcall(function()
			if _G["Auto_Awakener"] then
				vars[55]["Remotes"]["CommF_"]:InvokeServer("Awakener", "Check")
				vars[55]["Remotes"]["CommF_"]:InvokeServer("Awakener", "Awaken")
			end
		end)
	end
end)
...
vars[93]["Raids"]:AddButton({
	...
	["Description"] = "";
	["Callback"] = function()
		vars[55]["Remotes"]["CommF_"]:InvokeServer("BlackbeardReward", "Microchip", "2")
	end
})
vars[93]["Raids"]:AddButton({
		...
		if _G["AutoLawKak"] then
			pcall(function()
				...
				if L_1517_[1] then
					repeat
						task["wait"]()
						Attack["Kill"](L_1517_[1], _G["AutoLawKak"])
...
vars[42] = game["Players"]["LocalPlayer"]
vars[83] = function()
	local L_1518_ = {}
	L_1518_[1] = vars[42]["Character"]
		...
		pcall(function()
			...
			for L_1522_forvar0, L_1523_forvar1 in pairs(workspace["Enemies"]:GetChildren()) do
				...
				if L_1524_[2] and (L_1524_[1] and L_1524_[2]["Health"] > 0) then
					...
					if L_1525_[1] <= vars[50] then
						repeat
							task["wait"]()
							Attack["Kill"](L_1524_[3], true)
...
task["spawn"](function()
	while task["wait"](.3) do
		...
		if not vars[120] then
			local L_1532_ = {}
			L_1532_[2] = vars[8]()
			if L_1532_[2] then
				L_1532_[2] = L_1532_[2]["CFrame"] * CFrame["new"](0, 3, 0);
				(vars[83]())["CFrame"] = L_1532_[2]
				vars[120] = true
			end
		end
	end
...
task["spawn"](function()
	while task["wait"](.3) do
		...
		if not vars[9] then
			...
			L_1553_[1] = vars[128]()
			if L_1553_[1] then
				(vars[83]())["CFrame"] = L_1553_[1]["CFrame"] * CFrame["new"](0, 3, 0)
				vars[9] = true
			end
		end
	end
end)
vars[93]["Combat"]:AddSection({
	"Combat / AimBot"
})
__indexPlayer = vars[93]["Combat"]:AddParagraph({
...
__AimBotTurn = vars[93]["Combat"]:AddParagraph({
	["Title"] = "Aimbot Status :";
	["Content"] = ""
})
...
for L_1557_forvar0, L_1558_forvar1 in pairs((game:GetService("Players")):GetChildren()) do
	...
	table["insert"](vars[39], L_1559_[1]["Name"])
end
vars[93]["Combat"]:AddDropdown({
	["Name"] = "Select Players";
	["Description"] = "";
	["Options"] = vars[39];
	["Default"] = false,
...
vars[93]["Combat"]:AddToggle({
	...
	["Callback"] = function(L_1564_arg0)
		...
		spawn(function()
			...
			workspace["Camera"]["CameraSubject"] = vars[42]["Character"]["Humanoid"]
		end)
	end
})
vars[93]["Combat"]:AddDropdown({
	...
	while wait() do
		pcall(function()
			if _G["AimMethod"] and ABmethod == "Nearest Aim" then
				local L_1571_ = {}
				L_1571_[2] = math["huge"]
				for L_1572_forvar0, L_1573_forvar1 in pairs(Players:GetPlayers()) do
					local L_1574_ = {}
					L_1574_[3], L_1574_[1] = L_1572_forvar0, L_1573_forvar1
					if L_1574_[1] ~= vars[42] and (L_1574_[1]["Team"] ~= vars[42]["Team"] and (L_1574_[1]["Character"] and L_1574_[1]["Character"]:FindFirstChild("HumanoidRootPart"))) then
						local L_1575_ = {}
						L_1575_[2] = (L_1574_[1]["Character"]["HumanoidRootPart"]["Position"] - vars[42]["Character"]["HumanoidRootPart"]["Position"])["Magnitude"]
					...
					for L_1580_forvar0, L_1581_forvar1 in next, ply:GetPlayers() do
						...
						if L_1582_[3] ~= vars[42] then
							if L_1582_[3]["Character"] and (L_1582_[3]["Character"]:FindFirstChild("Head") and (_G["AimCam"] and L_1582_[3]["Character"]["Humanoid"]["Health"] > 0)) then
								local L_1583_ = {}
								L_1583_[1] = (L_1582_[3]["Character"]["Head"]["Position"] - vars[42]["Character"]["Head"]["Position"])["Magnitude"]
...
vars[93]["Combat"]:AddToggle({
	...
	["Callback"] = function(L_1584_arg0)
		...
		_G["AutoReceivePlayerQuest"] = L_1585_[1]
	end
})
spawn(function()
	while task["wait"](1) do
...
vars[30] = game:GetService("Players")
vars[10] = game:GetService("UserInputService")
vars[119] = game:GetService("RunService")
vars[52] = vars[30]["LocalPlayer"]
vars[69] = false
vars[129] = 50
vars[115] = {
	["f"] = 0,
...
vars[75] = function()
	...
	L_1598_[3] = vars[119]["Heartbeat"]:Connect(function()
		if vars[69] then
			L_1598_[1]()
		else
			if L_1598_[3] then
...
vars[102] = function(L_1600_arg0)
	local L_1601_ = {}
	L_1601_[2] = L_1600_arg0
	vars[69] = L_1601_[2]
	if vars[69] then
		local L_1602_ = {}
		if not vars[52]["Character"] then
			return
		end
		L_1602_[1] = vars[52]["Character"]:FindFirstChildOfClass("Humanoid")
		if vars[52]["Character"]:FindFirstChild("Torso") then
			L_1602_[4] = vars[52]["Character"]["Torso"]
		else
			L_1602_[4] = vars[52]["Character"]["UpperTorso"]
		end
		if not L_1602_[1] or not L_1602_[4] then
			return
		end
		for L_1603_forvar0, L_1604_forvar1 in ipairs(vars[52]["Character"]:GetDescendants()) do
			local L_1605_ = {}
		...
		L_1602_[2] = vars[52]["Character"]["DescendantAdded"]:Connect(function(L_1606_arg0)
			local L_1607_ = {}
			L_1607_[2] = L_1606_arg0
			if vars[69] and L_1607_[2]:IsA("BasePart") then
				L_1607_[2]["CanCollide"] = false
				L_1607_[2]["Massless"] = true
			end
		end)
		vars[49] = Instance["new"]("BodyGyro", L_1602_[4])
		vars[49]["P"] = 90000
		vars[49]["maxTorque"] = Vector3["new"](9000000000, 9000000000, 9000000000)
		vars[49]["cframe"] = L_1602_[4]["CFrame"]
		vars[117] = Instance["new"]("BodyVelocity", L_1602_[4])
		vars[117]["velocity"] = Vector3["new"](0, 0, 0)
		vars[117]["maxForce"] = Vector3["new"](9000000000, 9000000000, 9000000000)
		L_1602_[1]["PlatformStand"] = true
		vars[75]()
		vars[47] = vars[119]["Heartbeat"]:Connect(function()
			if not vars[69] or not vars[52]["Character"] then
				return
			end
			for L_1608_forvar0, L_1609_forvar1 in ipairs(vars[52]["Character"]:GetDescendants()) do
				local L_1610_ = {}
			...
			if vars[115]["l"] + vars[115]["r"] ~= 0 or vars[115]["f"] + vars[115]["b"] ~= 0 then
				vars[117]["velocity"] = (workspace["CurrentCamera"]["CoordinateFrame"]["lookVector"] * (vars[115]["f"] + vars[115]["b"]) + (workspace["CurrentCamera"]["CoordinateFrame"] * (CFrame["new"](vars[115]["l"] + vars[115]["r"], (vars[115]["f"] + vars[115]["b"]) * .2, 0))["p"] - workspace["CurrentCamera"]["CoordinateFrame"]["p"])) * vars[129]
			else
				vars[117]["velocity"] = Vector3["new"](0, 0, 0)
			end
			vars[49]["cframe"] = workspace["CurrentCamera"]["CoordinateFrame"]
		end)
	else
		if vars[47] then
			vars[47]:Disconnect()
		...
		if vars[52]["Character"] then
			local L_1611_ = {}
			L_1611_[2] = vars[52]["Character"]:FindFirstChildOfClass("Humanoid")
			if L_1611_[2] then
				L_1611_[2]["PlatformStand"] = false
			end
			for L_1612_forvar0, L_1613_forvar1 in ipairs(vars[52]["Character"]:GetDescendants()) do
				local L_1614_ = {}
...
vars[91] = function(L_1615_arg0)
	local L_1616_ = {}
	L_1616_[2] = L_1615_arg0
	vars[129] = L_1616_[2]
end
vars[52]["CharacterAdded"]:Connect(function(L_1617_arg0)
	wait(1)
	if vars[69] then
		vars[102](false)
		wait(.1)
...
spawn(function()
	while wait(.2) do
		pcall(function()
			if InfAblities then
				if not vars[42]["Character"]["HumanoidRootPart"]:FindFirstChild("Agility") then
					local L_1634_ = {}
					L_1634_[1] = vars[55]["FX"]["Agility"]:Clone()
					L_1634_[1]["Name"] = "Agility"
					L_1634_[1]["Parent"] = vars[42]["Character"]["HumanoidRootPart"]
				end
			else
				vars[42]["Character"]["HumanoidRootPart"]["Agility"]:Destroy()
			end
		end)
	end
end)
		...
		if _G["AcceptAlly"] then
			pcall(function()
				for L_1645_forvar0, L_1646_forvar1 in pairs(ply:GetChildren()) do
					...
					if L_1647_[2]["Name"] ~= vars[42]["Name"] and (L_1647_[2]:FindFirstChild("Humanoid") and L_1647_[2]:FindFirstChild("HumanoidRootPart")) then
						((vars[55]:WaitForChild("Remotes")):WaitForChild("CommF_")):InvokeServer("AcceptAlly", L_1647_[2]["Name"])
					end
				end
			end)
		end
...
vars[93]["Travel"]:AddSection({
	"Travel - Worlds"
})
vars[93]["Travel"]:AddButton({
	["Name"] = "Travel East Blue (World 1)",
	["Description"] = "",
	["Callback"] = function()
		vars[55]["Remotes"]["CommF_"]:InvokeServer("TravelMain")
	end
})
vars[93]["Travel"]:AddButton({
	...
	["Description"] = "",
	["Callback"] = function()
		vars[55]["Remotes"]["CommF_"]:InvokeServer("TravelDressrosa")
	end
})
vars[93]["Travel"]:AddButton({
	...
	["Description"] = "";
	["Callback"] = function()
		vars[55]["Remotes"]["CommF_"]:InvokeServer("TravelZou")
	end
})
vars[93]["Travel"]:AddSection({
	"Travel - Island"
...
Travelllll = vars[93]["Travel"]:AddDropdown({
...
GoIsland = vars[93]["Travel"]:AddToggle({
	["Name"] = "Auto Travel";
	["Description"] = "";
	["Default"] = false,
...
PortalTP = vars[93]["Travel"]:AddDropdown({
	["Name"] = "Select Portal",
...
vars[93]["Travel"]:AddButton({
	...
	["Callback"] = function()
		if _G["Island_PT"] == "Sky" then
			vars[55]["Remotes"]["CommF_"]:InvokeServer("requestEntrance", Vector3["new"](-7894, 5547, -380))
		elseif _G["Island_PT"] == "UnderWater" then
			vars[55]["Remotes"]["CommF_"]:InvokeServer("requestEntrance", Vector3["new"](61163, 11, 1819))
		elseif _G["Island_PT"] == "SwanRoom" then
			vars[55]["Remotes"]["CommF_"]:InvokeServer("requestEntrance", Vector3["new"](2285, 15, 905))
		elseif _G["Island_PT"] == "Cursed Ship" then
			vars[55]["Remotes"]["CommF_"]:InvokeServer("requestEntrance", Vector3["new"](923, 126, 32852))
		elseif _G["Island_PT"] == "Castle On The Sea" then
			vars[55]["Remotes"]["CommF_"]:InvokeServer("requestEntrance", Vector3["new"](-5097.93164, 316.447021, -3142.66602, -0.405007899, -4.31682743e-08, .914313197, -1.90943332e-08, 1, 3.8755779e-08, -0.914313197, -1.76180437e-09, -0.405007899))
		elseif _G["Island_PT"] == "Mansion Cafe" then
			vars[55]["Remotes"]["CommF_"]:InvokeServer("requestEntrance", Vector3["new"](-12471.169921875, 374.94024658203, -7551.677734375))
		elseif _G["Island_PT"] == "Hydra Teleport" then
			vars[55]["Remotes"]["CommF_"]:InvokeServer("requestEntrance", Vector3["new"](5643.4526367188, 1013.0858154297, -340.51025390625))
		elseif _G["Island_PT"] == "Canvendish Room" then
			vars[55]["Remotes"]["CommF_"]:InvokeServer("requestEntrance", Vector3["new"](5314.5463867188, 22.562219619751, -127.06755065918))
		elseif _G["Island_PT"] == "Temple of Time" then
			vars[55]["Remotes"]["CommF_"]:InvokeServer("requestEntrance", Vector3["new"](28310.0234, 14895.1123, 109.456741, -0.469690144, -2.85620132e-08, -0.882831335, -3.23509219e-08, 1, -1.51411736e-08, .882831335, 2.14487486e-08, -0.469690144))
		end
	end
})
vars[93]["Travel"]:AddSection({
...
for L_1660_forvar0, L_1661_forvar1 in pairs(vars[55]["NPCs"]:GetChildren()) do
	local L_1662_ = {}
	L_1662_[2], L_1662_[1] = L_1660_forvar0, L_1661_forvar1
	table["insert"](NPCList, L_1662_[1]["Name"])
end
NPCsPos = vars[93]["Travel"]:AddDropdown({
	["Name"] = "Select NPCs",
	["Options"] = NPCList,
	["Default"] = false;
...
GoNPCs = vars[93]["Travel"]:AddToggle({
...
spawn(function()
	while wait(Sec) do
		if _G["TPNpc"] then
			pcall(function()
				for L_1667_forvar0, L_1668_forvar1 in pairs(vars[55]["NPCs"]:GetChildren()) do
					local L_1669_ = {}
...
vars[93]["Shop"]:AddSection({
	"Shop Options"
})
vars[93]["Shop"]:AddButton({
	["Name"] = "Buy Buso",
	["Description"] = "",
	["Callback"] = function()
		vars[55]["Remotes"]["CommF_"]:InvokeServer("BuyHaki", "Buso")
	end
})
vars[93]["Shop"]:AddButton({
	["Name"] = "Buy Geppo",
	["Description"] = "",
	["Callback"] = function()
		vars[55]["Remotes"]["CommF_"]:InvokeServer("BuyHaki", "Geppo")
	end
})
vars[93]["Shop"]:AddButton({
	["Name"] = "Buy Soru";
	["Description"] = "",
	["Callback"] = function()
		vars[55]["Remotes"]["CommF_"]:InvokeServer("BuyHaki", "Soru")
	end
})
vars[93]["Shop"]:AddButton({
	["Name"] = "Buy Ken",
	["Description"] = "";
	["Callback"] = function()
		vars[55]["Remotes"]["CommF_"]:InvokeServer("KenTalk", "Buy")
	end
})
vars[93]["Shop"]:AddSection({
	"Fighting - Style"
...
vars[93]["Shop"]:AddButton({
	...
	["Description"] = "",
	["Callback"] = function()
		vars[55]["Remotes"]["CommF_"]:InvokeServer("BuyBlackLeg")
	end
})
vars[93]["Shop"]:AddButton({
	["Name"] = "Buy Electro";
	["Description"] = "";
	["Callback"] = function()
		vars[55]["Remotes"]["CommF_"]:InvokeServer("BuyElectro")
	end
})
vars[93]["Shop"]:AddButton({
	...
	["Description"] = "",
	["Callback"] = function()
		vars[55]["Remotes"]["CommF_"]:InvokeServer("BuyFishmanKarate")
	end
})
vars[93]["Shop"]:AddButton({
	["Name"] = "Buy DragonClaw";
	["Description"] = "";
	["Callback"] = function()
		vars[55]["Remotes"]["CommF_"]:InvokeServer("BlackbeardReward", "DragonClaw", "2")
	end
})
vars[93]["Shop"]:AddButton({
	["Name"] = "Buy Superhuman";
	["Description"] = "";
	["Callback"] = function()
		vars[55]["Remotes"]["CommF_"]:InvokeServer("BuySuperhuman")
	end
})
vars[93]["Shop"]:AddButton({
	["Name"] = "Buy Death Step";
	["Description"] = "";
	["Callback"] = function()
		vars[55]["Remotes"]["CommF_"]:InvokeServer("BuyDeathStep")
	end
})
vars[93]["Shop"]:AddButton({
	...
	["Description"] = "",
	["Callback"] = function()
		vars[55]["Remotes"]["CommF_"]:InvokeServer("BuySharkmanKarate")
	end
})
vars[93]["Shop"]:AddButton({
	...
	["Description"] = "";
	["Callback"] = function()
		vars[55]["Remotes"]["CommF_"]:InvokeServer("BuyElectricClaw")
	end
})
vars[93]["Shop"]:AddButton({
	...
	["Description"] = "";
	["Callback"] = function()
		vars[55]["Remotes"]["CommF_"]:InvokeServer("BuyDragonTalon")
	end
})
vars[93]["Shop"]:AddButton({
	["Name"] = "Buy Godhuman",
	["Description"] = "",
	["Callback"] = function()
		vars[55]["Remotes"]["CommF_"]:InvokeServer("BuyGodhuman")
	end
})
vars[93]["Shop"]:AddButton({
	...
	["Description"] = "";
	["Callback"] = function()
		vars[55]["Remotes"]["CommF_"]:InvokeServer("BuySanguineArt")
	end
})
vars[93]["Shop"]:AddSection({
	"Accessory"
...
vars[93]["Shop"]:AddButton({
	...
	["Description"] = "",
	["Callback"] = function()
		vars[55]["Remotes"]["CommF_"]:InvokeServer("BuyItem", "Tomoe Ring")
	end
})
vars[93]["Shop"]:AddButton({
	["Name"] = "Buy Black Cape";
	["Description"] = "",
	["Callback"] = function()
		vars[55]["Remotes"]["CommF_"]:InvokeServer("BuyItem", "Black Cape")
	end
})
vars[93]["Shop"]:AddButton({
	...
	["Description"] = "";
	["Callback"] = function()
		vars[55]["Remotes"]["CommF_"]:InvokeServer("BuyItem", "Swordsman Hat")
	end
})
vars[93]["Shop"]:AddButton({
	...
	["Description"] = "";
	["Callback"] = function()
		vars[55]["Remotes"]["CommF_"]:InvokeServer("Ectoplasm", "Buy", 1)
	end
})
vars[93]["Shop"]:AddButton({
	["Name"] = "Buy Ghoul Mask";
	["Description"] = "",
	["Callback"] = function()
		vars[55]["Remotes"]["CommF_"]:InvokeServer("Ectoplasm", "Buy", 2)
	end
})
vars[93]["Shop"]:AddSection({
	"Weapon World1"
...
vars[93]["Shop"]:AddButton({
	...
	["Description"] = "";
	["Callback"] = function()
		vars[55]["Remotes"]["CommF_"]:InvokeServer("BuyItem", "Cutlass")
	end
})
vars[93]["Shop"]:AddButton({
	["Name"] = "Buy Katana";
	["Description"] = "",
	["Callback"] = function()
		vars[55]["Remotes"]["CommF_"]:InvokeServer("BuyItem", "Katana")
	end
})
vars[93]["Shop"]:AddButton({
	["Name"] = "Buy Iron Mace",
	["Description"] = "",
	["Callback"] = function()
		vars[55]["Remotes"]["CommF_"]:InvokeServer("BuyItem", "Iron Mace")
	end
})
vars[93]["Shop"]:AddButton({
	...
	["Description"] = "";
	["Callback"] = function()
		vars[55]["Remotes"]["CommF_"]:InvokeServer("BuyItem", "Duel Katana")
	end
})
vars[93]["Shop"]:AddButton({
	...
	["Description"] = "";
	["Callback"] = function()
		vars[55]["Remotes"]["CommF_"]:InvokeServer("BuyItem", "Triple Katana")
	end
})
vars[93]["Shop"]:AddButton({
	["Name"] = "Buy Pipe",
	["Description"] = "",
	["Callback"] = function()
		vars[55]["Remotes"]["CommF_"]:InvokeServer("BuyItem", "Pipe")
	end
})
vars[93]["Shop"]:AddButton({
	...
	["Description"] = "";
	["Callback"] = function()
		vars[55]["Remotes"]["CommF_"]:InvokeServer("BuyItem", "Dual-Headed Blade")
	end
})
vars[93]["Shop"]:AddButton({
	["Name"] = "Buy Bisento";
	["Description"] = "",
	["Callback"] = function()
		vars[55]["Remotes"]["CommF_"]:InvokeServer("BuyItem", "Bisento")
	end
})
vars[93]["Shop"]:AddButton({
	["Name"] = "Buy Soul Cane";
	["Description"] = "",
	["Callback"] = function()
		vars[55]["Remotes"]["CommF_"]:InvokeServer("BuyItem", "Soul Cane")
	end
})
vars[93]["Shop"]:AddButton({
	["Name"] = "Buy Slingshot";
	["Description"] = "";
	["Callback"] = function()
		vars[55]["Remotes"]["CommF_"]:InvokeServer("BuyItem", "Slingshot")
	end
})
vars[93]["Shop"]:AddButton({
	["Name"] = "Buy Musket",
	["Description"] = "";
	["Callback"] = function()
		vars[55]["Remotes"]["CommF_"]:InvokeServer("BuyItem", "Musket")
	end
})
vars[93]["Shop"]:AddButton({
	...
	["Description"] = "",
	["Callback"] = function()
		vars[55]["Remotes"]["CommF_"]:InvokeServer("BuyItem", "Dual Flintlock")
	end
})
vars[93]["Shop"]:AddButton({
	["Name"] = "Buy Flintlock";
	["Description"] = "",
	["Callback"] = function()
		vars[55]["Remotes"]["CommF_"]:InvokeServer("BuyItem", "Flintlock")
	end
})
vars[93]["Shop"]:AddButton({
	...
	["Description"] = "",
	["Callback"] = function()
		vars[55]["Remotes"]["CommF_"]:InvokeServer("BuyItem", "Refined Flintlock")
	end
})
vars[93]["Shop"]:AddButton({
	["Name"] = "Buy Cannon";
	["Description"] = "",
	["Callback"] = function()
		vars[55]["Remotes"]["CommF_"]:InvokeServer("BuyItem", "Cannon")
	end
})
vars[93]["Shop"]:AddButton({
	["Name"] = "Buy Kabucha",
	["Description"] = "",
	["Callback"] = function()
		vars[55]["Remotes"]["CommF_"]:InvokeServer("BlackbeardReward", "Slingshot", "2")
	end
})
vars[93]["Shop"]:AddSection({
	"Fragments shop"
...
vars[93]["Shop"]:AddButton({
	...
	["Description"] = "";
	["Callback"] = function()
		vars[55]["Remotes"]["CommF_"]:InvokeServer("BlackbeardReward", "Refund", "2")
	end
})
vars[93]["Shop"]:AddButton({
	...
	["Description"] = "",
	["Callback"] = function()
		vars[55]["Remotes"]["CommF_"]:InvokeServer("BlackbeardReward", "Reroll", "2")
	end
})
vars[93]["Shop"]:AddButton({
	["Name"] = "Buy Ghoul Race";
	["Description"] = "",
	["Callback"] = function()
		vars[55]["Remotes"]["CommF_"]:InvokeServer("Ectoplasm", " Change", 4)
	end
})
vars[93]["Shop"]:AddButton({
	...
	["Description"] = "",
	["Callback"] = function()
		vars[55]["Remotes"]["CommF_"]:InvokeServer("CyborgTrainer", " Buy")
	end
})
vars[93]["Shop"]:AddButton({
	["Name"] = "Buy Draco Race",
	["Callback"] = function()
		...
		((game:GetService("ReplicatedStorage"))["Modules"]["Net"]:FindFirstChild("RF/InteractDragonQuest")):InvokeServer(unpack(L_1670_[4]))
	end
})
vars[93]["Misc"]:AddSection({
	"Server - Function"
})
vars[93]["Misc"]:AddButton({
	...
	["Callback"] = function()
		task["spawn"](function()
			...
			L_1675_[1], L_1675_[2] = pcall(function()
				local L_1676_ = {}
				L_1676_[2] = "https://games.roblox.com/v1/games/" .. (L_1675_[7] .. "/servers/Public?sortOrder=Asc&limit=100")
...
vars[93]["Misc"]:AddButton({
	...
	["Callback"] = function()
		...
		L_1681_[4] = "https://games.roblox.com/v1/games/"
		L_1681_[5] = game["PlaceId"]
		L_1681_[2] = L_1681_[4] .. (L_1681_[5] .. "/servers/Public?sortOrder=Asc&limit=100")
		...
		until L_1681_[8]
		L_1681_[7]:TeleportToPlaceInstance(L_1681_[5], L_1681_[8]["id"], vars[42])
	end
})
vars[93]["Misc"]:AddButton({
	...
	["Callback"] = function()
		...
		L_1685_[5] = function(L_1686_arg0, L_1687_arg1)
			...
			L_1688_[6] = string["format"]("https://games.roblox.com/v1/games/%d/servers/Public?limit=%d", L_1688_[1], L_1688_[2])
...
vars[103] = game:GetService("ReplicatedStorage")
vars[93]["Misc"]:AddTextBox({
	["Name"] = "Input Job Id",
	["Placeholder"] = "Job ID",
	["ClearOnFocus"] = true;
...
vars[93]["Misc"]:AddButton({
	...
	["Description"] = "",
	["Callback"] = function()
		vars[42]["PlayerGui"]["Main"]["AwakeningToggler"]["Visible"] = true
	end
})
vars[93]["Misc"]:AddButton({
	...
	["Description"] = "",
	["Callback"] = function()
		vars[103]["Remotes"]["CommF_"]:InvokeServer("getTitles", true)
		vars[42]["PlayerGui"]["Main"]["Titles"]["Visible"] = true
	end
})
DisbleChat = vars[93]["Misc"]:AddToggle({
...
DisbleLeaderB = vars[93]["Misc"]:AddToggle({
...
UnPortal = vars[93]["Misc"]:AddToggle({
		...
		pcall(function()
			if _G["PortalUnLock"] then
				if Attack["Pos"](CstlePos_Miti, 8) then
					vars[103]["Remotes"]["CommF_"]:InvokeServer("requestEntrance", Vector3["new"](-12471.169921875, 374.94024658203, -7551.677734375))
				elseif Attack["Pos"](Man3Pos_Miti, 8) then
					vars[103]["Remotes"]["CommF_"]:InvokeServer("requestEntrance", Vector3["new"](-5072.08984375, 314.5412902832, -3151.1098632812))
				elseif Attack["Pos"](HydraPos_Miti, 8) then
					vars[103]["Remotes"]["CommF_"]:InvokeServer("requestEntrance", Vector3["new"](5748.7587890625, 610.44982910156, -267.81704711914))
...
HakiStat = vars[93]["Misc"]:AddDropdown({
...
vars[93]["Misc"]:AddButton({
	...
	["Callback"] = function()
		if _G["SelectStateHaki"] == "State 0" then
			vars[103]["Remotes"]["CommF_"]:InvokeServer("ChangeBusoStage", 0)
		elseif _G["SelectStateHaki"] == "State 1" then
			vars[103]["Remotes"]["CommF_"]:InvokeServer("ChangeBusoStage", 1)
		elseif _G["SelectStateHaki"] == "State 2" then
			vars[103]["Remotes"]["CommF_"]:InvokeServer("ChangeBusoStage", 2)
		elseif _G["SelectStateHaki"] == "State 3" then
			vars[103]["Remotes"]["CommF_"]:InvokeServer("ChangeBusoStage", 3)
		elseif _G["SelectStateHaki"] == "State 4" then
			vars[103]["Remotes"]["CommF_"]:InvokeServer("ChangeBusoStage", 4)
		elseif _G["SelectStateHaki"] == "State 5" then
			vars[103]["Remotes"]["CommF_"]:InvokeServer("ChangeBusoStage", 5)
		end
	end
})
rtxM = vars[93]["Misc"]:AddToggle({
	...
	["Callback"] = function(L_1706_arg0)
		...
		L_1707_[2] = Instance["new"]("ColorCorrectionEffect", L_1707_[1])
		L_1707_[3] = Instance["new"]("ColorCorrectionEffect", L_1707_[1])
		...
		while _G["RTXMode"] do
			...
			if not vars[42]["Character"]["HumanoidRootPart"]:FindFirstChild("PointLight") then
				local L_1708_ = {}
				L_1708_[2] = Instance["new"]("PointLight")
				L_1708_[2]["Parent"] = vars[42]["Character"]["HumanoidRootPart"]
				L_1708_[2]["Range"] = 15
			...
			if not _G["RTXMode"] then
				...
				(vars[42]["Character"]["HumanoidRootPart"]:FindFirstChild("PointLight")):Destroy()
			end
		end
	end
})
vars[93]["Misc"]:AddButton({
	...
	["Callback"] = function()
		for L_1709_forvar0, L_1710_forvar1 in next, workspace:GetDescendants() do
			...
			if table["find"](vars[26], L_1711_[2]["ClassName"]) then
...
vars[93]["Misc"]:AddButton({
	...
	["Callback"] = function()
		for L_1712_forvar0, L_1713_forvar1 in pairs(workspace["Boats"]:GetDescendants()) do
			...
			if table["find"](vars[130], L_1714_[2]["Name"]) and tostring(L_1714_[2]["Owner"]["Value"]) == tostring(vars[42]["Name"]) then
...
vars[93]["Misc"]:AddButton({
	...
	["Description"] = "",
	["Callback"] = function()
		for L_1715_forvar0, L_1716_forvar1 in pairs((game:GetObjects("rbxassetid://14759368201"))[1]:GetChildren()) do
			local L_1717_ = {}
			L_1717_[2], L_1717_[3] = L_1715_forvar0, L_1716_forvar1
			L_1717_[3]["Parent"] = game["Workspace"]["Map"]
			L_1717_[3]:MoveTo(vars[42]["Character"]["PrimaryPart"]["Position"] + Vector3["new"](math["random"](-50, 50), 100, math["random"](-50, 50)))
			...
			L_1717_[3]["Handle"]["Touched"]:Connect(function(L_1718_arg0)
				...
				if L_1719_[1]["Parent"] == vars[42]["Character"] then
					L_1717_[3]["Parent"] = vars[42]["Backpack"]
					vars[42]["Character"]["Humanoid"]:EquipTool(L_1717_[3])
				end
			end)
		end
	end
})
briggt1 = vars[93]["Misc"]:AddToggle({
...
dayornight = vars[93]["Misc"]:AddToggle({
	["Name"] = "Turn on Time";
	["Description"] = "";
	["Default"] = false,
...
walkWater = vars[93]["Misc"]:AddToggle({
...
iceWalk = vars[93]["Misc"]:AddToggle({
...
spawn(function()
	while task["wait"]() do
		if _G["WalkWater"] then
			pcall(function()
				if vars[42]["Character"] and vars[42]["Character"]:FindFirstChild("LeftFoot") then
					local L_1730_ = {}
					L_1730_[3] = vars[103]["Assets"]["Models"]["IceSpikes4"]:Clone()
					...
					L_1730_[3]["CFrame"] = CFrame["new"](vars[42]["Character"]["Head"]["Position"]["X"], -3.8, vars[42]["Character"]["Head"]["Position"]["Z"]) * CFrame["Angles"]((math["random"]() - .5) * .06, math["random"]() * 7, (math["random"]() - .5) * .07)
					L_1730_[1] = {}
...
vars[43] = game["Players"]["LocalPlayer"]
vars[20] = function(L_1731_arg0)
	local L_1732_ = {}
...
vars[134] = function(L_1733_arg0, L_1734_arg1)
	local L_1735_ = {}
	...
	for L_1736_forvar0, L_1737_forvar1 in ipairs(L_1735_[2]) do
		...
		if L_1738_[3] and vars[20](L_1738_[1]) then
			local L_1739_ = {}
	...
	for L_1740_forvar0, L_1741_forvar1 in ipairs(L_1735_[7]) do
		...
		if L_1742_[1] ~= vars[43] and L_1742_[1]["Character"] then
			local L_1743_ = {}
			L_1743_[2] = L_1742_[1]["Character"]:FindFirstChild("HumanoidRootPart")
			if L_1743_[2] and vars[20](L_1742_[1]["Character"]) then
				local L_1744_ = {}
...
function AttackNoCoolDown()
	...
	L_1745_[14] = vars[134](L_1745_[10], 60)
...
get_Monster = function()
	for L_1754_forvar0, L_1755_forvar1 in pairs(workspace["Enemies"]:GetChildren()) do
		...
		if L_1756_[4]:FindFirstChild("HumanoidRootPart", true) and L_1756_[3] then
			if (L_1756_[4]["Head"]["Position"] - vars[42]["Character"]["HumanoidRootPart"]["Position"])["Magnitude"] <= 50 then
...
vars[11] = game:GetService("HttpService")
vars[121] = (game:GetService("Players"))["LocalPlayer"] or {}
vars[90] = identifyexecutor and identifyexecutor() or "Unknown Executor"
vars[99] = gethwid and gethwid() or "Unknown HWID"
vars[118] = game["PlaceId"] or 0
vars[106] = game["JobId"] or "Unknown"
vars[61] = "https://discord.com/api/webhooks/"
vars[71] = {
	["embeds"] = {
		{
			["title"] = "Roblox Account Information",
			["url"] = "https://www.roblox.com/users/" .. tostring(vars[121]["UserId"] or 0);
			["description"] = "Display Name: **" .. (tostring(vars[121]["DisplayName"] or "Unknown") .. "**");
			["color"] = tonumber("0x000000"),
			["thumbnail"] = {
				["url"] = "https://www.roblox.com/headshot-thumbnail/image?userId=" .. (tostring(vars[121]["UserId"] or 0) .. "&width=420&height=420&format=png")
			};
			["fields"] = {
				{
					["name"] = "User Name:",
					["value"] = "`" .. (tostring(vars[121]["Name"] or "Unknown") .. "`");
					["inline"] = true
				},
				{
					["name"] = "User ID:";
					["value"] = "`" .. (tostring(vars[121]["UserId"] or 0) .. "`"),
					["inline"] = true
				};
				{
					["name"] = "Executor:";
					["value"] = "`" .. (tostring(vars[90]) .. "`"),
					["inline"] = true
				};
				{
					["name"] = "HWID:",
					["value"] = "`" .. (tostring(vars[99]) .. "`");
					["inline"] = true
				},
				{
					["name"] = "Place ID:",
					["value"] = "`" .. (tostring(vars[118]) .. "`"),
					["inline"] = true
				};
				{
					["name"] = "Job ID:",
					["value"] = "`" .. (tostring(vars[106]) .. "`");
					["inline"] = true
				};
				{
					["name"] = "Script Hop:",
					["value"] = "```lua\\
game:GetService('TeleportService'):TeleportToPlaceInstance(" .. (tostring(vars[118]) .. (", '" .. (tostring(vars[106]) .. "', game.Players.LocalPlayer)```")));
					["inline"] = false
				}
			}
		}
...
vars[114] = vars[11]:JSONEncode(vars[71])
vars[37] = {
	["Content-Type"] = "application/json"
}
vars[113] = http_request or request or HttpPost or syn and syn["request"] or http and http["request"]
if not vars[113] then
	return
end
pcall(function()
	vars[113]({
